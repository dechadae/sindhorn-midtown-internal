export const ROUTES=Object.freeze({
  ...
  settings:Object.freeze({path:'/settings',title:'Settings | Sindhorn Midtown Internal',kind:'local',module:'./settings-route-v3.js?v=13&r=frameless-signout-1',mount:'mountSettingsRoute'}),
  ci:Object.freeze({path:'/ci',title:'UI Library | Sindhorn Midtown Internal',kind:'local',module:'./ci-day-cycle-route.js?v=2',mount:'mountCiRoute'})
});
...
// Cache lineage: settings-route-v3.js?v=10&r=6&d=5 -> v11&r=ci-1 -> v12&r=release-health-1 -> v13&r=frameless-signout-1.
