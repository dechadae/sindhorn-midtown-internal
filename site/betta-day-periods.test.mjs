...
const expected=[
  ['midnight',0,'reference1',1],['before-dawn',3,'reference7',7],['first-light',6,'reference4',4],['bright-morning',9,'reference6',6],['midday',12,'reference2',2],['afternoon',15,'reference3',3],['golden-hour',18,'reference5',5],['blue-hour',21,'reference8',8]
];
