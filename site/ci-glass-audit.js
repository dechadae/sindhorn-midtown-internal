...
function glassSectionMarkup(){
  ...
  return`<section class="ci-section" id="ci-glass" data-ci-section="glass">
    <header class="ci-section-head">
      ...
      <p class="ci-section-lede">Any card, button, chip, field, menu or navigation item that intentionally shows the live atmosphere through its fill uses the centralized glass material. Fully transparent controls and opaque surfaces are exempt.</p>
    </header>
    <div class="ci-grid">
