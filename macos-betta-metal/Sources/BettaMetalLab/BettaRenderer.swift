...
final class BettaRenderer: NSObject, MTKViewDelegate {
    ...
    private func makeFinUniforms(from:BettaPreset,to:BettaPreset,mix e:Float,layerIndex:Int,aspect:Float,viewProjection:simd_float4x4)->FinUniforms {
        ...
        let pos=lerp(ma.position,mb.position,e), scale=p(a.scale*la.scale*ma.scaleMultiplier,b.scale*lb.scale*mb.scaleMultiplier), rx=lerpAngle(a.rotationX,b.rotationX,e), ry=lerpAngle(a.rotationY,b.rotationY,e), rz=lerpAngle(a.rotation+la.rotation,b.rotation+lb.rotation,e)
