...
for(const label of ['Share'])assert.match(ui,new RegExp(label));
for(const bad of ['SHOW FULL','SHOW LESS','ADD / CHANGE ARTWORK LINK','SAVE','SHARE'])assert(!ui.includes(bad),`forced uppercase action regressed: ${bad}`);
