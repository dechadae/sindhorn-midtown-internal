export const BETTA_PRESETS={
  cobaltVeil:{
    ...
    params:{
      spread:3.42,rayCount:56,foldDensity:5.9,curl:.58,twist:-.33,edgeFlutter:.22,depth:.62,
  ...
  crimsonSilk:{
    ...
    params:{
      spread:3.82,rayCount:64,foldDensity:8.4,curl:1.08,twist:.52,edgeFlutter:.31,depth:.96,
      currentStrength:.62,motionSpeed:.62,turbulence:.68,motionAmplitude:.9,
  ...
  turquoiseDrift:{
    ...
    params:{
      spread:3.18,rayCount:52,foldDensity:6.7,curl:.72,twist:-.74,edgeFlutter:.19,depth:1.08,
      currentStrength:.46,motionSpeed:.54,turbulence:.46,motionAmplitude:.72,
  ...
  midnightPlum:{
    ...
    params:{
      spread:4.28,rayCount:48,foldDensity:4.7,curl:1.3,twist:.82,edgeFlutter:.12,depth:1.2,
      currentStrength:.34,motionSpeed:.42,turbulence:.34,motionAmplitude:.62,
