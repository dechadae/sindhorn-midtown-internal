...
descriptionNode.textContent='Approved radial-fin direction with independently tuned fish colors and synchronized dark gradient atmospheres.';
...
function paint(){
  ...
  stateNode.textContent=`${day.periodName||day.targetPeriodKey||'—'} · Fish #${current?.referenceId||'—'} · fine tune · ${Math.round((Number(day.transitionMix)||0)*100)}%`;
