...
const parts=splitContactName(card.displayName);if(parts.given!=='Decha'||parts.family!=='Kokaew')throw new Error('Contact name split failed');
...
console.log(JSON.stringify({slug:'dechak',url:`${ORIGIN}/dechak`,vcardUrl:`${ORIGIN}/dechak.vcf`,hotel:HOTEL,logo:LOGO,qr:{version:6,errorCorrection:'M',quietZoneModules:4,viewBox:49}},null,2));
