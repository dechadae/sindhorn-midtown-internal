export const ROUTES=Object.freeze({
  ...
  settings:Object.freeze({path:'/settings',title:'Settings | Sindhorn Midtown Internal',kind:'local',module:'./settings-route-v3.js?v=3',mount:'mountSettingsRoute'})
});

const PATH_TO_ROUTE=new Map(Object.entries(ROUTES).map(([key,value])=>[value.path,key]));
const LEGACY_ALIASES=new Map([
  ['/index.html','today'],['/guidance','today'],['/details','today'],
  ['/account','settings'],['/account.html','settings'],['/admin','settings'],['/admin.html','settings']
]);
