...
<link rel="stylesheet" href="/share/fnb-public.css?v=3">
</head>
...
<script type="module" src="/share/fnb-public-shell.js?v=3"></script>
</body>
</html>\n`;
...
const css=`:root{--sm-text:#FAF7F5;--sm-gutter:20px;--public-header-h:70px}html,body{min-height:100%;margin:0;background:#2E273B;color:var(--sm-text);letter-spacing:0!important}html{-webkit-tap-highlight-color:transparent}body[data-fnb-public="true"]{overflow-x:hidden}body[data-fnb-public="true"] *,body[data-fnb-public="true"] *::before,body[data-fnb-public="true"] *::after{-webkit-tap-highlight-color:transparent!important}body[data-fnb-public="true"] button,body[data-fnb-public="true"] a{-webkit-appearance:none;appearance:none}body[data-fnb-public="true"] button:focus:not(:focus-visible),body[data-fnb-public="true"] a:focus:not(:focus-visible){outline:none!important;box-shadow:none!important}.environment-stage{position:fixed!important;inset:0!important;z-index:0!important}.public-app-header{position:relative;z-index:20;height:var(--public-header-h);box-sizing:border-box;padding:8px var(--sm-gutter);display:flex;align-items:center;background:#2E273B;border-bottom:1px solid rgba(250,247,245,.08)}.public-app-header img{display:block;width:109px;height:auto;max-height:54px;object-fit:contain}body[data-fnb-public="true"] #route-view{position:relative;z-index:2;box-sizing:border-box;min-height:calc(100dvh - var(--public-header-h));padding:0 var(--sm-gutter) max(38px,env(safe-area-inset-bottom));background:transparent}body[data-fnb-public="true"] .fnb-route{min-height:calc(100dvh - var(--public-header-h))}body[data-fnb-public="true"] .fnb-task-toggle{display:none!important}body[data-fnb-public="true"] .fnb-task{grid-template-columns:minmax(0,1fr)!important;padding-left:0!important}body[data-fnb-public="true"] [data-folder-edit],body[data-fnb-public="true"] [data-folder-open],body[data-fnb-public="true"] [data-save-links],body[data-fnb-public="true"] .fnb-sheet-layer{display:none!important}body[data-fnb-public="true"] .fnb-section-rail{display:none!important;visibility:hidden!important;opacity:0!important;pointer-events:none!important}body[data-fnb-public="true"][data-fnb-detail="true"] #route-view{padding-bottom:max(38px,env(safe-area-inset-bottom))!important}body[data-fnb-public="true"] .fnb-back,body[data-fnb-public="true"] .fnb-action-control,body[data-fnb-public="true"] .fnb-chip{color:inherit}body[data-fnb-public="true"] .fnb-back:active,body[data-fnb-public="true"] .fnb-action-control:active{outline:none!important;box-shadow:none!important}@media(min-width:700px){:root{--sm-gutter:32px}.public-app-header img{width:109px}body[data-fnb-public="true"] #route-view{max-width:760px;margin:0 auto}}`;
