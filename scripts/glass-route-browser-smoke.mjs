...
try{
  for(const spec of routes){
    ...
    const report=await page.evaluate(({rootSelector,probeClass,checkBackdropRoot})=>{
      ...
      probe.remove();
      return result;
    },{rootSelector:spec.root,probeClass:spec.probe,checkBackdropRoot:spec.checkBackdropRoot});
