export const ROUTES=Object.freeze({
  ...
  settings:Object.freeze({path:'/settings',title:'Settings | Sindhorn Midtown Internal',kind:'local',module:'./settings-route-v3.js?v=11&r=ci-1',mount:'mountSettingsRoute'}),
  ci:Object.freeze({path:'/ci',title:'UI Library | Sindhorn Midtown Internal',kind:'local',module:'./ci.js?v=1',mount:'mountCiRoute'})
});
// Today cache lineage: today:Object.freeze({path:'/',title:'Today | Sindhorn Midtown Internal',kind:'local',module:'./business-dashboard.js?v=2',mount:'mountBusinessDashboardRoute'}) -> v3 for explicit freshness/domain separation.
// Cache lineage: settings-route-v3.js?v=10&r=6&d=5 -> v11&r=ci-1 for fixed Settings rail + developer UI Library.
