const VERSION='sindhorn-midtown-internal-pwa-v86-fnb-r16b';
...
const SHELL=['/','/index.html','/route-registry.js','/business-dashboard.js','/business-dashboard-data.js','/business-dashboard.css','/business-dashboard-motion.js','/business-dashboard-motion.css','/hotel-factsheet.css','/app-transitions.js','/app-transitions.css','/startup-skeleton.js','/startup-skeleton.js?v=1','/startup-skeleton.css','/startup-skeleton.css?v=1','/startup-skeleton.css?v=2','/pwa-version-guard.js','/pwa-version-guard.js?v=2','/footer-route-guard.js','/footer-route-guard.css','/auth-shell.js','/auth-shell.js?v=5','/auth-shell.css','/auth-client.js','/account.js','/account.css','/admin.js','/fnb-route.js','/fnb.js','/fnb-data.js','/fnb.css','/fnb-approved-polish.css','/qr-v6.js','/shell.css','/assets/fonts/line-seed-sans-th-bold.woff2','/assets/fonts/line-seed-sans-th-regular.woff2','/assets/fonts/line-seed-sans-th-thin.woff2','/fonts.css','/fonts.css?v=1','/environment.css','/environment.css?v=5','/pwa.css','/location.js','/bootstrap.js','/bootstrap.js?v=2','/live-data.js','/betta-runtime.js','/betta-runtime.js?v=1','/betta-runtime.js?v=2','/betta-runtime-full.js','/betta-runtime-full.js?v=1','/betta-fin-presets.js','/betta-fin-shader.js','/betta-satellite.js','/betta-day-periods.js','/push-config.js','/push-client.js','/notification-inbox.js','/screen-capture.js','/presentation-recovery.js','/app.js','/manifest.webmanifest','/fallback/manifest.json','/fallback/header.html','/fallback/today.html','/fallback/guidance.html','/fallback/details.html','/fallback/messages.html','/fallback/footer.html','/fallback/ui.css','/fallback/environment-config.json','/icons/app-192.png','/icons/app-512.png','/icons/maskable-512.png','/icons/apple-touch-icon.png','/assets/brand/sindhorn-midtown-vignette-white.png','/assets/brand/sindhorn-midtown-vignette-black.png','/app-glass-runtime.js','/app-glass.css','/app-components.css','/app-shell.css','/ci.html','/ci-library.css','/ci-library.js','/ci-page.js','/brand-page.js','/ihg-history-data.js','/hotel-factsheet-data.js','/next.html','/today.js','/fnb-page.js','/fnb-read-model.js','/app-controls.css','/app-shapes.css','/route-hero-standard.css','/brand-route-controls.js','/rain-now.js','/app-tokens.css','/app-select.js','/shell.js','/app-code.js','/signin-page.js','/settings-page.js','/messages-page.js','/capabilities.js','/app-view.js','/app-dialog.js','/app-toast.js','/settings-me.js','/settings-admin.js','/business-card-core.js','/settings-broadcast.js','/broadcast-inbox.js'];
/* Install resilience.
...
const CRITICAL_SHELL=['/','/index.html','/shell.css','/fonts.css','/app-glass.css','/app-components.css','/app-shell.css','/app-glass-runtime.js','/bootstrap.js','/route-registry.js','/auth-shell.js','/auth-client.js','/manifest.webmanifest'];
