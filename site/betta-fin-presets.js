...
export const BETTA_PRESETS={
  reference1:preset({
    ...
    params:{
      ...
      scale:.74,rotation:.28,rotationX:-.30,rotationY:.44,tiltStrength:.18,cameraDepth:.10,offsetX:-.08,offsetY:-.58
    },
    layers:[
  ...
  reference3:preset({
    ...
    params:{
      ...
      scale:.71,rotation:.38,rotationX:-.38,rotationY:.26,tiltStrength:.20,cameraDepth:.08,offsetX:.36,offsetY:.62
    },
    layers:[
  ...
  reference4:preset({
    ...
    params:{
      ...
      scale:.92,rotation:-.44,rotationX:.32,rotationY:.56,tiltStrength:.17,cameraDepth:.12,offsetX:-1.48,offsetY:-1.02
    },
    layers:[
  ...
  reference6:preset({
    ...
    params:{
      ...
      scale:.73,rotation:.30,rotationX:.38,rotationY:.34,tiltStrength:.18,cameraDepth:.09,offsetX:.18,offsetY:-.74
    },
    layers:[
  ...
  reference7:preset({
    ...
    params:{
      ...
      scale:.79,rotation:-.28,rotationX:-.34,rotationY:.58,tiltStrength:.22,cameraDepth:.11,offsetX:.12,offsetY:.92
    },
    layers:[
