import {mountSettingsRoute as mountBaseSettingsRoute} from './settings.js?v=3';
import {mountSettingsBusinessCard,preloadSettingsBusinessCard} from './business-card-settings.js?v=9';
...
export async function mountSettingsRoute(root){
  ...
  try{
    await Promise.all([
      ...
      ensureStyle('link[data-settings-dialog-standard]','/settings-dialog-standard.css?v=2','data-settings-dialog-standard'),
      ensureStyle('link[data-business-card-component]','/business-card-component.css?v=1','data-business-card-component'),
