...
DIST="$ROOT/dist"
APP="$DIST/BETTA.app"
ZIP="$DIST/BETTA-1.1.2-macOS-arm64.zip"
DMG="$DIST/BETTA-1.1.2-macOS-arm64.dmg"
...
# BETTA 1.1.2 preserves the approved native Metal renderer and persistence
# domains. Imagine is now a true in-window Liquid Glass overlay rather than a
# second macOS panel, and broad theme/mood prompts use decisive global-restyle
# semantics while explicit keep/only/more-less prompts remain refinements.
