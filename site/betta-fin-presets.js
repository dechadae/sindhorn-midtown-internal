...
export const BETTA_PRESETS={
  reference1:preset({
    ...
    params:{
      ...
      scale:.80,rotation:.28,rotationX:-.30,rotationY:.44,tiltStrength:.18,cameraDepth:.10,offsetX:-1.02,offsetY:-.36
    },
    layers:[
  ...
  reference2:preset({
    ...
    params:{
      ...
      scale:.78,rotation:-.22,rotationX:.24,rotationY:-.52,tiltStrength:.16,cameraDepth:.08,offsetX:-1.05,offsetY:.28
    },
    layers:[
  ...
  reference3:preset({
    ...
    params:{
      ...
      scale:.82,rotation:.38,rotationX:-.38,rotationY:.26,tiltStrength:.20,cameraDepth:.08,offsetX:-.98,offsetY:-.42
    },
    layers:[
  ...
  reference4:preset({
    ...
    params:{
      ...
      scale:.80,rotation:-.44,rotationX:.32,rotationY:.56,tiltStrength:.17,cameraDepth:.12,offsetX:-1.00,offsetY:.38
    },
    layers:[
  ...
  reference5:preset({
    ...
    params:{
      ...
      scale:.80,rotation:.12,rotationX:-.26,rotationY:-.46,tiltStrength:.21,cameraDepth:.08,offsetX:-1.02,offsetY:-.24
    },
    layers:[
  ...
  reference6:preset({
    ...
    params:{
      ...
      scale:.82,rotation:.30,rotationX:.38,rotationY:.34,tiltStrength:.18,cameraDepth:.09,offsetX:-1.04,offsetY:-.36
    },
    layers:[
  ...
  reference7:preset({
    ...
    params:{
      ...
      scale:.80,rotation:-.28,rotationX:-.34,rotationY:.58,tiltStrength:.22,cameraDepth:.11,offsetX:-.98,offsetY:.30
    },
    layers:[
