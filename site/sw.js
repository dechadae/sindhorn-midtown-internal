const VERSION='sindhorn-midtown-internal-pwa-v134-contract-integrity-r54';
...
const SHELL=['/','/index.html','/fonts.css','/fonts.css?v=2','/app-tokens.css','/app-tokens.css?v=11','/app-glass.css','/app-glass.css?v=12','/app-components.css','/app-components.css?v=39','/app-compositions.css','/app-compositions.css?v=1','/app-shell.css','/app-shell.css?v=3','/assets/fonts/line-seed-sans-th-thin.woff2','/assets/fonts/line-seed-sans-th-regular.woff2','/assets/fonts/line-seed-sans-th-bold.woff2','/assets/brand/sindhorn-midtown-vignette-white.png','/assets/brand/sindhorn-midtown-vignette-black.png','/icons/app-192.png','/icons/app-512.png','/icons/maskable-512.png','/icons/apple-touch-icon.png','/manifest.webmanifest','/shell.js','/auth-client.js','/notification-inbox.js','/broadcast-inbox.js','/capabilities.js','/push-config.js','/push-client.js','/app-view.js','/app-dialog.js','/app-disclosure.js','/app-drag-sort.js','/app-select.js','/app-toast.js','/app-code.js','/qr-v6.js','/signin-page.js','/today.js','/fnb-page.js','/fnb-read-model.js','/fnb-artwork-copy.js','/messages-page.js','/jobs-page.js','/brand-page.js','/ihg-history-data.js','/hotel-factsheet-data.js','/settings-page.js','/settings-me.js','/settings-admin.js','/settings-broadcast.js','/business-card-core.js','/business-card-page.js','/business-dashboard-data.js','/betta-runtime-full.js','/betta-runtime-full.js?v=1','/ci.html','/ci-library.css','/ci-library.css?v=10','/ci-library.js','/ci-page.js','/voice.html','/voice-page.js','/app-format.js','/app-html.js','/readability-page.js','/betta-random.js','/betta-readability.js','/betta-day-periods.js','/betta-fin-presets.js'];
/* Install resilience.
...
const CRITICAL_SHELL=['/','/index.html','/fonts.css','/app-tokens.css','/app-glass.css','/app-components.css','/app-compositions.css','/app-shell.css','/shell.js','/auth-client.js','/notification-inbox.js','/broadcast-inbox.js','/signin-page.js','/today.js','/manifest.webmanifest'];
