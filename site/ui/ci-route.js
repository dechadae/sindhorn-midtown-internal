...
function card(title,copy,extra=''){return `<article class="ui-card"><p class="ui-eyebrow">${title}</p><p class="ui-copy" style="margin-top:12px">${copy}</p>${extra}</article>`}
...
export async function mountCiRoute(host){
  ...
  route.innerHTML=`
    ...
    ${section('Loading','Startup and route loading use pulse/crossfade only. No ray, arrow, shimmer sweep or temporary fish artwork.',`<div class="ui-skeleton-stack"><div class="ui-skeleton ui-skeleton--line" style="width:28%"></div><div class="ui-skeleton ui-skeleton--title"></div><div class="ui-skeleton ui-skeleton--card"></div><div class="ui-skeleton ui-skeleton--card"></div></div>`)}
    ...
    ${section('Dialog','Dialogs use the same frosted material, radii, controls and focus treatment.',`<button class="ui-button ui-button--secondary" type="button" data-ui-dialog-open>Open dialog</button><dialog class="ui-dialog" data-ui-dialog><div class="ui-dialog__body"><p class="ui-eyebrow">Dialog</p><h2 style="margin:8px 0 12px;font-weight:400">Central dialog primitive</h2><p class="ui-copy">Routes provide content; the shell system owns the material and action layout.</p></div><div class="ui-dialog__actions"><button class="ui-button ui-button--secondary" type="button" data-ui-dialog-close>Close</button><button class="ui-button ui-button--primary" type="button" data-ui-dialog-close>Done</button></div></dialog>`)}
