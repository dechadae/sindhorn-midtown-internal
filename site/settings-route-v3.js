...
import {mountSettingsBusinessCard,preloadSettingsBusinessCard} from './business-card-settings.js?v=10';
// Cache lineage: business-card-settings.js?v=9 -> v10 for the fixed-shell renderer.
// Cache lineage: /settings-dialog-standard.css?v=1&r=3 -> r=4 for inner-scroll standardization.
...
export async function mountSettingsRoute(root){
  ...
  try{
    await Promise.all([
      ...
      ensureStyle('link[data-settings-dialog-standard]','/settings-dialog-standard.css?v=1&r=4','data-settings-dialog-standard'),
