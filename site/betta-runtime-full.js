...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Hc(){return new Lt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Jo(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Gc(){return new Lt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Jo(),fragmentShader:`
...
`)}function Am(i,e){let t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){let s=i.getActiveAttrib(e,r),a=s.name,o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Or(i){return i!==""}function eu(i,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function tu(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var Cm=/^[ \t]*#include +<([\w\d./]+)>/gm;function Wo(i){return i.replace(Cm,Im)}var Rm=new Map;function Im(i,e){let t=Oe[e];if(t===void 0){let n=Rm.get(e);if(n!==void 0)t=Oe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Wo(t)}var Pm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function nu(i){return i.replace(Pm,Dm)}function Dm(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function iu(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function Lm(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===po?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Zl?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===un&&(e="SHADOWMAP_TYPE_VSM"),e}function Um(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case fi:case pi:e="ENVMAP_TYPE_CUBE";break;case Ir:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Fm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case pi:e="ENVMAP_MODE_REFRACTION";break}return e}function Nm(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case xo:e="ENVMAP_BLENDING_MULTIPLY";break;case fc:e="ENVMAP_BLENDING_MIX";break;case pc:e="ENVMAP_BLENDING_ADD";break}return e}function Om(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Bm(i,e,t,n){let r=i.getContext(),s=t.defines,a=t.vertexShader,o=t.fragmentShader,c=Lm(t),l=Um(t),u=Fm(t),h=Nm(t),f=Om(t),p=Tm(t),_=wm(s),v=r.createProgram(),m,d,w=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Or).join(`
`)),a=Wo(a),a=eu(a,t),a=tu(a,t),o=Wo(o),o=eu(o,t),o=tu(o,t),a=nu(a),o=nu(o),t.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+d);let E=w+m+a,M=w+d+o,A=Kc(r,r.VERTEX_SHADER,E),C=Kc(r,r.FRAGMENT_SHADER,M);r.attachShader(v,A),r.attachShader(v,C),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function I(P){if(i.debug.checkShaderErrors){let z=r.getProgramInfoLog(v)||"",H=r.getShaderInfoLog(A)||"",X=r.getShaderInfoLog(C)||"",J=z.trim(),W=H.trim(),ne=X.trim(),k=!0,ae=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(k=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,v,A,C);else{let ue=Qc(r,A,"vertex"),be=Qc(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
`;var gu="/api/betta-satellite",Ko={lat:13.7563,lon:100.5018},tn={west:99,east:110,north:16,south:7},_u="Himawari-9 \xB7 JMA High-Resolution Asia 1",ft=(i,e=0,t=1)=>Math.min(t,Math.max(e,i)),Ca=(i,e,t)=>i+(e-i)*t;function jo(i){if(i instanceof Date)return i;let e=String(i||"").trim().replace(" ","T");return new Date(/[zZ]|[+-]\d\d:?\d\d$/.test(e)?e:`${e}Z`)}function pu(i){return String(i).padStart(2,"0")}function cg(i){let e=jo(i);if(!Number.isFinite(e.getTime()))throw new Error("Invalid Himawari timestamp");return`${pu(e.getUTCHours())}${pu(Math.floor(e.getUTCMinutes()/10)*10)}`}function ug(i){let e=jo(i);return new Date(e.getTime()-600*1e3)}function hg(i,e){let t=new URLSearchParams({kind:"frame",band:i,time:cg(e)});return`${gu}?${t}`}async function Ra(i,e){let t=await fetch(hg(i,e),{cache:"no-store"});if(!t.ok)throw new Error(`${i} Himawari frame ${t.status}`);let n=await t.blob(),r=await createImageBitmap(n),s=document.createElement("canvas");s.width=r.width,s.height=r.height;let a=s.getContext("2d",{willReadFrequently:!0});if(!a)throw new Error("Satellite analysis canvas unavailable");return a.drawImage(r,0,0),r.close?.(),a.getImageData(0,0,s.width,s.height)}function dg(i){let e=ft((Ko.lon-tn.west)/(tn.east-tn.west)),t=ft((tn.north-Ko.lat)/(tn.north-tn.south));return{x:e*(i.width-1),y:t*(i.height-1),xNorm:e,yNorm:t}}function Ia(i,e=.72){let t=dg(i),n=Math.max(18,Math.round(i.width*e/(tn.east-tn.west))),r=Math.max(18,Math.round(i.height*e/(tn.north-tn.south))),s=Math.round(t.x),a=Math.round(t.y),o=Math.max(1,s-n),c=Math.min(i.width-2,s+n),l=Math.max(1,a-r),u=Math.min(i.height-2,a+r),h=c-o+1,f=u-l+1;if(h<12||f<12)throw new Error("Bangkok satellite patch too small");let p=new Float32Array(h*f),_=new Float32Array(h*f*3),v=0,m=0;for(let d=l;d<=u;d++)for(let w=o;w<=c;w++){let E=(d*i.width+w)*4,M=i.data[E]/255,A=i.data[E+1]/255,C=i.data[E+2]/255;p[v++]=M*.2126+A*.7152+C*.0722,_[m++]=M,_[m++]=A,_[m++]=C}return{gray:p,rgb:_,width:h,height:f,left:o,top:l,sourceWidth:i.width,sourceHeight:i.height,centerX:t.x,centerY:t.y,radiusDegrees:e}}function fg(i){let e=0;for(let t=0;t<i.length;t++)e+=i[t];return i.length?e/i.length:0}function mu(i){if(!i.length)return 0;let e=fg(i),t=0;for(let n=0;n<i.length;n++){let r=i[n]-e;t+=r*r}return Math.sqrt(t/i.length)}function Zn(i,e){if(!i.length)return 0;let t=Array.from(i).sort((n,r)=>n-r);return t[Math.min(t.length-1,Math.max(0,Math.floor((t.length-1)*e)))]}function xu(i){let{gray:e,width:t,height:n}=i;if(t<3||n<3)return 0;let r=0,s=0;for(let a=1;a<n-1;a+=2)for(let o=1;o<t-1;o+=2){let c=a*t+o,l=e[c+1]-e[c-1],u=e[c+t]-e[c-t];r+=Math.sqrt(l*l+u*u),s++}return s?r/s:0}function pg(i,e){let t=Zn(i.gray,.3),n=Zn(i.gray,.7),r=Zn(i.gray,.9),s=Zn(i.gray,.97),a=Zn(e.gray,.7),o=Zn(e.gray,.9),c=Math.max(.025,s-t),l=t+c*.43,u=0;for(let v=0;v<i.gray.length;v++)i.gray[v]>l&&u++;let h=ft(u/Math.max(1,i.gray.length)),f=ft((r-t)/Math.max(.08,c)),p=ft((r-o)*3.2+(n-a)*2.1,-1,1),_=ft(xu(i)/.14);return{cloudAmount:h,coldCloud:f,cooling:p,texture:_,p30:t,p70:n,p90:r,p97:s}}function mg(i,e){let t=Math.min(i.width,e.width),n=Math.min(i.height,e.height),r=Math.max(2,Math.min(9,Math.floor(Math.min(t,n)/10))),s=r+3,a={score:-2,dx:0,dy:0};for(let l=-r;l<=r;l++)for(let u=-r;u<=r;u++){let h=0,f=0,p=0;for(let M=s;M<n-s;M+=2)for(let A=s;A<t-s;A+=2)h+=i.gray[M*i.width+A],f+=e.gray[(M-l)*e.width+(A-u)],p++;if(!p)continue;let _=h/p,v=f/p,m=0,d=0,w=0;for(let M=s;M<n-s;M+=2)for(let A=s;A<t-s;A+=2){let C=i.gray[M*i.width+A]-_,I=e.gray[(M-l)*e.width+(A-u)]-v;m+=C*I,d+=C*C,w+=I*I}let E=m/Math.sqrt(Math.max(1e-8,d*w));E>a.score&&(a={score:E,dx:u,dy:l})}let o=Math.sqrt(a.dx*a.dx+a.dy*a.dy),c=ft((a.score-.18)/.67);return{dx:a.dx,dy:a.dy,correlation:a.score,confidence:c,magnitude:o,energy:ft(o/6)*c}}function gg(i){let e=Zn(i.gray,.72),t=Zn(i.gray,.25),n=ft(xu(i)/.15),r=ft((e-t)/.42)*.68+n*.32;return{moisture:ft(r),texture:n,p25:t,p72:e}}function _g(i){let e=0,t=0,n=0,r=0,s=0,a=0;for(let _=0;_<i.gray.length;_++){let v=i.gray[_];if(v>.025){let m=_*3;e+=i.rgb[m],t+=i.rgb[m+1],n+=i.rgb[m+2],r+=v,a++}s++}if(!a)return{confidence:0,color:[.16,.22,.52],meanLuma:0};e/=a,t/=a,n/=a,r/=a;let o=ft((r-.035)/.17)*ft(a/Math.max(1,s)*1.8),c=Math.max(e,t,n),l=Math.min(e,t,n),u=c-l,h=u>.01?Math.min(2.2,.28/u):1,f=(e+t+n)/3,p=[ft(f+(e-f)*h),ft(f+(t-f)*h),ft(f+(n-f)*h)];return{confidence:o,color:p,meanLuma:r}}function xg(...i){let e=2166136261;for(let s of i){let a=s.gray,o=Math.max(1,Math.floor(a.length/421));for(let c=0;c<a.length;c+=o)e^=Math.round(a[c]*255)&255,e=Math.imul(e,16777619)>>>0}let t=(e&65535)/65535,n=(e>>>8&65535)/65535,r=(e>>>16&65535)/65535;return{hash:e.toString(16).padStart(8,"0"),a:t,b:n,c:r}}function vg({latest:i,currentIR:e,previousIR:t,waterVapor:n,visible:r}){let s=mu(e.gray),a=mu(n.gray);if(s<.006||a<.004)throw new Error(`Degenerate Himawari Bangkok patch (IR ${s.toFixed(4)}, WV ${a.toFixed(4)})`);let o=pg(e,t),c=mg(e,t),l=gg(n),u=_g(r),h=xg(e,n),f=Math.max(0,o.cooling),p=ft(.62+c.energy*.2+o.texture*.13+o.coldCloud*.08+f*.18,.62,1),_=Math.atan2(-c.dy,c.dx),v=(h.a*2-1)*Math.PI,m=Ca(v,_,c.confidence),d=.5+p*.55,w=[Math.cos(m)*d,Math.sin(m)*d],E=[ft(.16+.48*o.coldCloud+.16*h.c),ft(.15+.48*l.moisture+.14*h.b),ft(.4+.4*(1-o.coldCloud)+.18*h.a)],M=[Ca(E[0],u.color[0],u.confidence*.7),Ca(E[1],u.color[1],u.confidence*.7),Ca(E[2],u.color[2],u.confidence*.7)];return{status:"live",inputMode:"satellite-only",satellite:"Himawari-9",provider:"JMA",source:_u,sector:i.sector||"High-Resolution Asia 1",bounds:i.bounds||tn,observedAt:i.observedAt||i.date,sourceLastModified:i.sourceLastModified||null,cadenceMinutes:i.cadenceMinutes||10,bangkok:{...Ko,imageWidth:e.sourceWidth,imageHeight:e.sourceHeight,pixelX:+e.centerX.toFixed(1),pixelY:+e.centerY.toFixed(1),radiusDegrees:e.radiusDegrees},metrics:{cloudAmount:+o.cloudAmount.toFixed(3),coldCloud:+o.coldCloud.toFixed(3),cooling:+o.cooling.toFixed(3),cloudTexture:+o.texture.toFixed(3),waterVapor:+l.moisture.toFixed(3),motionX:c.dx,motionY:c.dy,motionMagnitude:+c.magnitude.toFixed(3),motionConfidence:+c.confidence.toFixed(3),visibleConfidence:+u.confidence.toFixed(3),energy:+p.toFixed(3),fingerprint:h.hash,irVariation:+s.toFixed(4),vaporVariation:+a.toFixed(4)},drivers:{energy:p,cloud:o.cloudAmount,cold:o.coldCloud,cooling:o.cooling,texture:o.texture,vapor:l.moisture,motion:w,color:M,visible:u.confidence,fingerprint:[h.a,h.b,h.c]}}}async function yg(){let i=await fetch(`${gu}?kind=latest`,{cache:"no-store"});if(!i.ok)throw new Error(`Himawari metadata ${i.status}`);let e=await i.json();if(!e?.ok||!(e.observedAt||e.date))throw new Error(e?.error||"Himawari metadata unavailable");return e}async function Mg(i){let e=jo(i.observedAt||i.date),t=ug(e),[n,r,s,a]=await Promise.all([Ra("b13",e),Ra("b13",t),Ra("b08",e),Ra("b03",e)]);return{currentIR:Ia(n),previousIR:Ia(r),waterVapor:Ia(s),visible:Ia(a)}}async function Sg(){let i=await yg(),e=await Mg(i);return vg({latest:i,...e})}function vu({onState:i,onError:e,intervalMs:t=9e4}={}){let n=!1,r="";async function s(){try{let o=await Sg();if(n)return;o.observedAt!==r&&(r=o.observedAt,i?.(o))}catch(o){n||e?.(o)}}s();let a=setInterval(s,Math.max(3e4,t));return()=>{n=!0,clearInterval(a)}}var yu=_u;var Qo="Asia/Bangkok";var yi=Object.freeze([Object.freeze({key:"midnight",startHour:0,endHour:3,name:"Midnight",baseline:"reference1",referenceId:1,tone:"dark"}),Object.freeze({key:"before-dawn",startHour:3,endHour:6,name:"Before Dawn",baseline:"reference2",referenceId:2,tone:"dark"}),Object.freeze({key:"first-light",startHour:6,endHour:9,name:"First Light",baseline:"reference3",referenceId:3,tone:"bright"}),Object.freeze({key:"bright-morning",startHour:9,endHour:12,name:"Bright Morning",baseline:"reference4",referenceId:4,tone:"bright"}),Object.freeze({key:"midday",startHour:12,endHour:15,name:"Midday",baseline:"reference5",referenceId:5,tone:"bright"}),Object.freeze({key:"afternoon",startHour:15,endHour:18,name:"Afternoon",baseline:"reference6",referenceId:6,tone:"bright"}),Object.freeze({key:"golden-hour",startHour:18,endHour:21,name:"Golden Hour",baseline:"reference7",referenceId:7,tone:"dark"}),Object.freeze({key:"blue-hour",startHour:21,endHour:24,name:"Blue Hour",baseline:"reference8",referenceId:8,tone:"dark"})]),bg=i=>Math.min(1,Math.max(0,Number(i)||0)),Eg=new Intl.DateTimeFormat("en-GB",{timeZone:Qo,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}),Mu=i=>1-Math.pow(1-bg(i),3);function el(i){let e=((Number(i)||0)%1440+1440)%1440,t=e/60;return yi.find(n=>t>=n.startHour&&t<n.endHour)||yi[0]}function tl(i=new Date){let e=Object.fromEntries(Eg.formatToParts(i).filter(s=>s.type!=="literal").map(s=>[s.type,s.value])),t=Number(e.hour)||0,n=Number(e.minute)||0,r=Number(e.second)||0;return{hour:t,minute:n,second:r,minuteOfDay:t*60+n+r/60,label:`${String(t).padStart(2,"0")}:${String(n).padStart(2,"0")}:${String(r).padStart(2,"0")}`}}function nl(i=new Date){return el(tl(i).minuteOfDay)}function Mi(i){return yi.find(e=>e.key===i)||null}var Su=2,Si=72,Tg="https://api.open-meteo.com/v1/forecast?latitude=13.74135&longitude=100.54274&current=temperature_2m,apparent_temperature,relative_humidity_2m,precipitation,rain,showers,snowfall,weather_code,cloud_cover,wind_speed_10m,wind_direction_10m,wind_gusts_10m,visibility,is_day&timezone=Asia%2FBangkok",Du="sindhorn-midtown:weather:v2",al="sindhorn-midtown:betta-styles:v1",wg=2700*1e3,Lu=Object.freeze(Object.keys(en)),Ag=Math.max(...Lu.map(i=>en[i].params.rayCount)),gl=Object.freeze(["offsetX","offsetY","cameraDepth","scale","rotationX","rotationY","rotation"]),Cg=Object.freeze([...gl,"tiltStrength"]),Kn=(i,e=0,t=1)=>Math.min(t,Math.max(e,Number(i)||0)),Mt=(i,e,t)=>i+(e-i)*t,il=(i,e,t)=>{let n=(e-i)%(Math.PI*2);return n>Math.PI&&(n-=Math.PI*2),n<-Math.PI&&(n+=Math.PI*2),i+n*t},bu=!1,Jn=null,bi=null,In=null,pn=null,Pn=null,rl=null,Pa=null,mn=null,Dn=0,Eu=0,ol=performance.now(),La=!1,Zt=Aa,$n=$o(Aa),rr=null,Ei=!document.hidden,Uu=Ei?"active":"suspended",nn=!1,Fu="initial",ar=[],Ti=[],_l="sindhorn-midtown:betta-mode:v1",ll="sindhorn-midtown:betta-preference:v1",Rg=10080*60*1e3,Ig=.42,Tu=[.12,.6],Pg=90,Dg=28,wu=600,Lg=3e3,xl=matchMedia("(prefers-reduced-motion: reduce)"),$e={current:"betta",reason:"default",requested:"auto",skyTime:20,frameMs:null,governor:{startedAt:0,frames:[],done:!1}},pt={known:!1,cached:!1,cloudCover:0,precipitationMm:0,rainMm:0,showersMm:0,snowfallCm:0,humidity:.68,windSpeedKmh:4,windDirectionDeg:180,windGustKmh:null,visibilityKm:20,temperatureC:null,apparentTemperatureC:null,weatherCode:null,isDay:null,observedAt:null},Au={energy:.58,cloud:.35,cold:.35,cooling:0,texture:.32,vapor:.42,motion:[0,0],color:[.18,.23,.52],visible:0,fingerprint:[.5,.5,.5]},cl=i=>({energy:i.energy,cloud:i.cloud,cold:i.cold,cooling:i.cooling,texture:i.texture,vapor:i.vapor,motion:[...i.motion],color:[...i.color],visible:i.visible,fingerprint:[...i.fingerprint]}),at={status:"loading",state:null,error:null,current:cl(Au),target:cl(Au),transitionBoost:0},Y={mode:"live",period:null,targetPeriod:null,from:null,to:null,t0:0,duration:0,mix:1,rawMix:1,reason:"initial",pin:null,preview:null},Pe={supported:"DeviceOrientationEvent"in window,enabled:!1,listening:!1,permission:"unknown",calibrated:!1,beta0:0,gamma0:0,targetX:0,targetY:0,currentX:0,currentY:0,lastAt:0},Ug=new Set([51,53,55,56,57,61,63,65,66,67,80,81,82,95,96,99]),Fg=new Set([51,53,55,56,57]),Nu=new Set([95,96,99]);function Ou(i){let e=Number(i);return e===0?"Clear":e===1?"Mainly clear":e===2?"Partly cloudy":e===3?"Overcast":[45,48].includes(e)?"Fog":Fg.has(e)?"Drizzle":[61,63,65,66,67].includes(e)?"Rain":[71,73,75,77].includes(e)?"Snow":[80,81,82].includes(e)?"Rain showers":[85,86].includes(e)?"Snow showers":Nu.has(e)?"Thunderstorm":"Current weather"}function Ng(i){return["N","NE","E","SE","S","SW","W","NW"][Math.round(((Number(i)||0)%360+360)%360/45)%8]}function Og(i){let e=Number(i.weatherCode),t=Kn(i.cloudCover),n=Math.max(0,Number(i.precipitationMm)||0),r=Math.max(n,Number(i.rainMm)||0,Number(i.showersMm)||0);return{cloud:t,rain:Kn(Math.max(Ug.has(e)?.35:0,r/8)),storm:Nu.has(e)?1:0,type:Ou(e).toLowerCase().replaceAll(" ","-")}}function ul(){let i=document.getElementById("weatherNow");if(!i||!pt.known||!Number.isFinite(pt.temperatureC))return;let e=Number.isFinite(pt.apparentTemperatureC)?Math.round(pt.apparentTemperatureC):Math.round(pt.temperatureC),t=(n,r)=>{let s=document.getElementById(n);s&&(s.textContent=r)};t("weatherTemp",`${Math.round(pt.temperatureC)}\xB0`),t("weatherConditionEn",Ou(pt.weatherCode)),t("weatherMetaEn",`Feels ${e}\xB0 \xB7 RH ${Math.round(pt.humidity*100)}% \xB7 Wind ${Ng(pt.windDirectionDeg)} ${Math.round(pt.windSpeedKmh)} km/h`),i.hidden=!1}function Bg(){try{let i=JSON.parse(localStorage.getItem(Du)||"null");return!i||!i.savedAt||Date.now()-i.savedAt>wg?null:i.value||null}catch{return null}}function zg(i){try{localStorage.setItem(Du,JSON.stringify({savedAt:Date.now(),value:i}))}catch{}}async function Da(){let i=Bg();i&&!pt.known&&(Object.assign(pt,i,{known:!0,cached:!0}),ul());let e=await fetch(Tg,{cache:"no-store",credentials:"omit"});if(!e.ok)throw new Error("weather "+e.status);let t=await e.json(),n=t.current||{},r=(s,a=null)=>Number.isFinite(Number(s))?Number(s):a;return Object.assign(pt,{known:!0,cached:!1,cloudCover:Kn(r(n.cloud_cover,0)/100),precipitationMm:Math.max(0,r(n.precipitation,0)),rainMm:Math.max(0,r(n.rain,0)),showersMm:Math.max(0,r(n.showers,0)),snowfallCm:Math.max(0,r(n.snowfall,0)),humidity:Kn(r(n.relative_humidity_2m,68)/100),windSpeedKmh:Math.max(0,r(n.wind_speed_10m,4)),windDirectionDeg:(r(n.wind_direction_10m,180)%360+360)%360,windGustKmh:r(n.wind_gusts_10m),visibilityKm:Math.max(.1,r(n.visibility,2e4)/1e3),temperatureC:r(n.temperature_2m),apparentTemperatureC:r(n.apparent_temperature),weatherCode:r(n.weather_code),isDay:r(n.is_day),observedAt:n.time||null}),zg(pt),ul(),document.dispatchEvent(new CustomEvent("sindhorn:weather-updated",{detail:{weatherCode:pt.weatherCode,precipitationMm:pt.precipitationMm}})),pt}function Je(i){return new We(i)}var kg=`
varying vec2 vUv;
...
`;function Hg(i){let e=Je(i),t=n=>n<=.0031308?n*12.92:1.055*Math.pow(n,1/2.4)-.055;return .2126*t(e.r)+.7152*t(e.g)+.0722*t(e.b)}function hl(i){let e=i.palette.slice(0,4).reduce((t,n)=>t+Hg(n),0);return Math.min(Tu[1],Math.max(Tu[0],Ig/Math.max(.05,e)))}function dl(i){let e=i.params;return[Math.min(.92,Math.max(.08,.5+(e.offsetX||0)*.21)),Math.min(.55,Math.max(.3,.42+(e.offsetY||0)*.12))]}function fl(i){let e=i.backgroundGradient;return Array.isArray(e)&&e.length>=3?e:[i.background,i.background,i.background]}function Gg(i){let e=fl(i),t=at.current;mn=new Lt({vertexShader:kg,fragmentShader:Vg,depthTest:!1,depthWrite:!1,transparent:!1,toneMapped:!1,uniforms:{uBg0From:{value:Je(e[0])},uBg1From:{value:Je(e[1])},uBg2From:{value:Je(e[2])},uBg0To:{value:Je(e[0])},uBg1To:{value:Je(e[1])},uBg2To:{value:Je(e[2])},uMix:{value:1},uSatelliteColor:{value:new N(...t.color)},uSatelliteMix:{value:.025+.025*t.cloud+.018*t.visible},uSky:{value:$e.current==="sky"?1:0},uTime:{value:$e.skyTime},uPlume:{value:hl(i)},uAnchor:{value:new He(...dl(i))},uP0From:{value:Je(i.palette[0])},uP1From:{value:Je(i.palette[1])},uP2From:{value:Je(i.palette[2])},uP3From:{value:Je(i.palette[3])},uP0To:{value:Je(i.palette[0])},uP1To:{value:Je(i.palette[1])},uP2To:{value:Je(i.palette[2])},uP3To:{value:Je(i.palette[3])},uSkyMotion:{value:new He(t.motion[0],t.motion[1])},uSkyEnergy:{value:t.energy},uSkyCloud:{value:t.cloud},uSkyVapor:{value:t.vapor},uSkyCold:{value:t.cold}}}),Pa=new Rt(new hi(2,2),mn),Pa.frustumCulled=!1,Pa.renderOrder=-1e3,pn.add(Pa)}function Wg(i,e,t){if(!mn)return;let n=fl(i),r=fl(e),s=mn.uniforms;for(let c=0;c<3;c++)s["uBg"+c+"From"].value.copy(Je(n[c])),s["uBg"+c+"To"].value.copy(Je(r[c]));for(let c=0;c<4;c++)s["uP"+c+"From"].value.copy(Je(i.palette[c])),s["uP"+c+"To"].value.copy(Je(e.palette[c]));let a=dl(i),o=dl(e);s.uAnchor.value.set(Mt(a[0],o[0],t),Mt(a[1],o[1],t)),s.uPlume.value=Mt(hl(i),hl(e),t),s.uMix.value=t}function Xg(i){let e=Math.max(32,Math.min(80,Math.round(i/4)*4)),t=(e+1)*(Si+1),n=new Float32Array(t*3),r=new Float32Array(t),s=new Float32Array(t),a=new Float32Array(t),o=[],c=[];for(let u=0;u<=e;u++){let h=u/e,f=Math.sin((u+1)*12.9898+78.233)*43758.5453,p=Math.sin((u+7)*4.123+21.731)*15731.743;c[u]=(f-Math.floor(f)-.5)*1.4+(p-Math.floor(p)-.5)*.6;for(let _=0;_<=Si;_++){let v=u*(Si+1)+_;r[v]=_/Si,s[v]=h,a[v]=c[u]}}for(let u=0;u<e;u++)for(let h=0;h<Si;h++){let f=u*(Si+1)+h,p=f+Si+1;o.push(f,p,f+1,p,p+1,f+1)}let l=new cn;return l.setAttribute("position",new yt(n,3)),l.setAttribute("aU",new yt(r,1)),l.setAttribute("aV",new yt(s,1)),l.setAttribute("aRayJitter",new yt(a,1)),l.setIndex(o),l.computeBoundingSphere(),l}function pl(i,e){let t=i.layers[e],n=i.layers[0]||{};return t?{seed:t.seed??0,phase:t.phase||0,scale:t.scale||1,rotation:t.rotation||0,offset:[...t.offset||[0,0,0]],alpha:t.alpha??1}:{seed:(n.seed||0)+13.37*(e+1),phase:(n.phase||0)+11.9*(e+1),scale:n.scale||1,rotation:n.rotation||0,offset:[...n.offset||[0,0,0]],alpha:0}}function Cu(i,e,t){i[e].value.copy(Je(t))}function qg(i,e){let t=e.params,n=at.current,r=pl(e,i);return new Lt({vertexShader:du,fragmentShader:fu,transparent:!0,depthTest:!0,depthWrite:!1,side:qt,blending:En,uniforms:{uTime:{value:0},uSeed:{value:r.seed},uPhase:{value:r.phase},uSpread:{value:t.spread},uFoldDensity:{value:t.foldDensity},uCurl:{value:t.curl},uTwist:{value:t.twist},uEdgeFlutter:{value:t.edgeFlutter},uDepth:{value:t.depth},uCurrentStrength:{value:t.currentStrength},uMotionSpeed:{value:t.motionSpeed},uTurbulence:{value:t.turbulence},uMotionAmplitude:{value:t.motionAmplitude},uCurrent:{value:new He(n.motion[0],n.motion[1])},uOpacity:{value:t.opacity},uTransmission:{value:t.transmission},uRimStrength:{value:t.rimStrength},uFoldHighlight:{value:t.foldHighlight},uIridescence:{value:t.iridescence},uBloom:{value:t.bloom},uSaturation:{value:t.saturation},uBrightness:{value:t.brightness},uGradientPosition:{value:t.gradientPosition},uLayerAlpha:{value:r.alpha},uMorphModeFrom:{value:e.morphMode||0},uMorphModeTo:{value:e.morphMode||0},uMorphTransition:{value:1},uColor0From:{value:Je(e.palette[0])},uColor1From:{value:Je(e.palette[1])},uColor2From:{value:Je(e.palette[2])},uColor3From:{value:Je(e.palette[3])},uColor0To:{value:Je(e.palette[0])},uColor1To:{value:Je(e.palette[1])},uColor2To:{value:Je(e.palette[2])},uColor3To:{value:Je(e.palette[3])},uSatelliteEnergy:{value:n.energy},uSatelliteCloud:{value:n.cloud},uSatelliteCold:{value:n.cold},uSatelliteCooling:{value:n.cooling},uSatelliteTexture:{value:n.texture},uSatelliteVapor:{value:n.vapor},uSatelliteVisible:{value:n.visible},uSatelliteMotion:{value:new He(n.motion[0],n.motion[1])},uSatelliteColor:{value:new N(...n.color)},uSatelliteFingerprint:{value:new N(...n.fingerprint)}}})}function Bu(){for(let i of ar)pn.remove(i);for(let i of Ti)i.dispose();ar.length=0,Ti.length=0}function vl(){Bu(),rl?.dispose(),rl=Xg(Ag);for(let i=0;i<2;i++){let e=qg(i,$n),t=new Rt(rl,e);t.renderOrder=i,t.frustumCulled=!1,pn.add(t),ar.push(t),Ti.push(e)}Br($n,$n,1)}function Yg(i,e,t,n){return Mt(i.params[t],e.params[t],n)}function Br(i,e,t){let n=Kn(t);$n=e,Zt=n>=1&&(Y.targetPeriod?.baseline||e.__key)||Zt,Wg(i,e,n);for(let r=0;r<Ti.length;r++){let s=Ti[r],a=ar[r],o=s.uniforms,c=pl(i,r),l=pl(e,r);for(let h of["spread","foldDensity","curl","twist","edgeFlutter","depth","currentStrength","motionSpeed","turbulence","motionAmplitude","opacity","transmission","rimStrength","foldHighlight","iridescence","bloom","saturation","brightness","gradientPosition"])o["u"+h[0].toUpperCase()+h.slice(1)].value=Yg(i,e,h,n);o.uSeed.value=Mt(c.seed,l.seed,n),o.uPhase.value=Mt(c.phase,l.phase,n),o.uLayerAlpha.value=Mt(c.alpha,l.alpha,n),o.uMorphModeFrom.value=i.morphMode||0,o.uMorphModeTo.value=e.morphMode||0,o.uMorphTransition.value=n;for(let h=0;h<4;h++)Cu(o,`uColor${h}From`,i.palette[h]),Cu(o,`uColor${h}To`,e.palette[h]);let u=Mt(i.params.scale*(c.scale||1),e.params.scale*(l.scale||1),n);a.scale.setScalar(u),a.rotation.order="YXZ",a.userData.baseRotationX=il(i.params.rotationX||0,e.params.rotationX||0,n),a.userData.baseRotationY=il(i.params.rotationY||0,e.params.rotationY||0,n),a.userData.baseRotationZ=il(i.params.rotation+(c.rotation||0),e.params.rotation+(l.rotation||0),n),a.userData.tiltStrength=Mt(i.params.tiltStrength||.16,e.params.tiltStrength||.16,n),a.rotation.set(a.userData.baseRotationX,a.userData.baseRotationY,a.userData.baseRotationZ,"YXZ"),a.position.set(Mt(i.params.offsetX+(c.offset[0]||0),e.params.offsetX+(l.offset[0]||0),n),Mt(i.params.offsetY+(c.offset[1]||0),e.params.offsetY+(l.offset[1]||0),n),Mt(i.params.cameraDepth+(c.offset[2]||0),e.params.cameraDepth+(l.offset[2]||0),n)),a.userData.baseZ=a.position.z}}function Zg(){let i=at.current;for(let e of Ti){let t=e.uniforms;t.uCurrent.value.set(i.motion[0],i.motion[1]),t.uSatelliteEnergy.value=i.energy,t.uSatelliteCloud.value=i.cloud,t.uSatelliteCold.value=i.cold,t.uSatelliteCooling.value=i.cooling,t.uSatelliteTexture.value=i.texture,t.uSatelliteVapor.value=i.vapor,t.uSatelliteVisible.value=i.visible,t.uSatelliteMotion.value.set(i.motion[0],i.motion[1]),t.uSatelliteColor.value.set(i.color[0],i.color[1],i.color[2]),t.uSatelliteFingerprint.value.set(i.fingerprint[0],i.fingerprint[1],i.fingerprint[2])}if(mn){let e=mn.uniforms;e.uSatelliteColor.value.set(i.color[0],i.color[1],i.color[2]),e.uSatelliteMix.value=.025+.025*i.cloud+.018*i.visible,e.uSkyMotion.value.set(i.motion[0],i.motion[1]),e.uSkyEnergy.value=i.energy,e.uSkyCloud.value=i.cloud,e.uSkyVapor.value=i.vapor,e.uSkyCold.value=i.cold}}function Jg(){try{let i=JSON.parse(localStorage.getItem(_l)||"null");return!!(i&&i.mode==="sky"&&Date.now()-Number(i.at||0)<Rg)}catch{return!1}}function $g(){try{localStorage.setItem(_l,JSON.stringify({mode:"sky",at:Date.now()}))}catch{}}function yl(){try{let i=localStorage.getItem(ll);return i==="sky"||i==="betta"?i:"auto"}catch{return"auto"}}function Kg(i="auto"){let e=i==="sky"||i==="betta"?i:"auto";try{e==="auto"?localStorage.removeItem(ll):localStorage.setItem(ll,e),e==="betta"&&localStorage.removeItem(_l)}catch{}return Ml(),$e.current}function zu(){if($e.requested!=="auto")return[$e.requested,"requested"];let i=yl();return i!=="auto"?[i,"preference"]:xl.matches?["sky","reduced-motion"]:Jg()?["sky","low-end"]:["betta","default"]}function ku(i,e){let t=i!==$e.current;$e.current=i,$e.reason=e,document.body.dataset.bettaMode=i,document.body.dataset.bettaModeReason=e,pn&&(t&&(i==="sky"?Bu():vl()),mn&&(mn.uniforms.uSky.value=i==="sky"?1:0),jn())}function Ml(){let[i,e]=zu();(i!==$e.current||e!==$e.reason)&&ku(i,e)}function jg(i="auto"){return $e.requested=i==="sky"||i==="betta"?i:"auto",Ml(),$e.current}function Vu(){return $e.current==="sky"&&xl.matches}function Qg(i,e){let t=$e.governor;if(t.done||$e.current!=="betta"||$e.requested!=="auto"||yl()!=="auto"||navigator.webdriver)return;if(!t.startedAt){t.startedAt=i;return}if(i-t.startedAt<wu||(t.frames.push(e),i-t.startedAt<wu+Lg))return;t.done=!0;let n=[...t.frames].sort((r,s)=>r-s);$e.frameMs=n[n.length>>1]||0,$e.frameMs>Dg&&($g(),ku("sky","low-end"))}function e0(i){let e=i*.001,t=at.transitionBoost,n=1-Math.exp(-e*(.13+t*.22)),r=at.current,s=at.target;for(let a of["energy","cloud","cold","cooling","texture","vapor","visible"])r[a]=Mt(r[a],s[a],n);for(let a=0;a<2;a++)r.motion[a]=Mt(r.motion[a],s.motion[a],n);for(let a=0;a<3;a++)r.color[a]=Mt(r.color[a],s.color[a],n),r.fingerprint[a]=Mt(r.fingerprint[a],s.fingerprint[a],n);at.transitionBoost=Math.max(0,t-e*.055)}var wi=new Map;function t0(i,e){if(!e)return i;if(Array.isArray(e.palette)&&e.palette.length>=4&&(i.palette=e.palette.slice(0,4).map(String)),Array.isArray(e.backgroundGradient)&&e.backgroundGradient.length>=3&&(i.backgroundGradient=e.backgroundGradient.slice(0,3).map(String),i.background=String(e.background||e.backgroundGradient[0])),e.params&&typeof e.params=="object")for(let t of Object.keys(i.params)){if(gl.includes(t)||t==="rayCount"||t==="tiltStrength")continue;let n=Number(e.params[t]);Number.isFinite(n)&&(i.params[t]=n)}if(e.camera&&typeof e.camera=="object")for(let t of Cg){let n=Number(e.camera[t]);Number.isFinite(n)&&(i.params[t]=n)}return Array.isArray(e.layers)&&e.layers.length&&(i.layers=e.layers.map((t,n)=>{let r=i.layers[n]||i.layers[0]||{};return{...r,...t,offset:[...t.offset||r.offset||[0,0,0]]}})),i.__seed=e.seed==null?null:String(e.seed),i}function or(i){let e=t0($o(i),wi.get(i));return e.__key=i,e}function Hu(i=900,e="style"){let t=Y.targetPeriod;if(!t||!en[t.baseline])return!1;let n=Y.to||or(Zt),r=or(t.baseline);return Y.from=n,Y.to=r,Y.period=t,Y.t0=performance.now(),Y.duration=Math.max(0,i),Y.rawMix=i>0?0:1,Y.mix=Y.rawMix,Y.reason=e,i<=0&&Br(r,r,1),jn(),!0}function n0(i,e,t=900){let n=Mi(i);return n?(e&&typeof e=="object"?wi.set(n.baseline,e):wi.delete(n.baseline),Y.targetPeriod?.key===n.key&&Hu(t,"style"),!0):!1}function i0(i,e=900){wi.clear();for(let[t,n]of Object.entries(i||{})){let r=Mi(t);r&&n&&typeof n=="object"&&wi.set(r.baseline,n)}return Y.targetPeriod&&Hu(e,"styles"),!0}function Gu(){return Object.fromEntries(yi.map(i=>[i.key,wi.get(i.baseline)||null]))}function r0(){try{let i=JSON.parse(localStorage.getItem(al)||"null");if(!i||typeof i!="object")return;for(let[e,t]of Object.entries(i)){let n=Mi(e);n&&t&&typeof t=="object"&&wi.set(n.baseline,t)}}catch{}}function s0(i=Gu()){try{let e=Object.fromEntries(Object.entries(i||{}).filter(([t,n])=>Mi(t)&&n&&typeof n=="object"));return Object.keys(e).length?localStorage.setItem(al,JSON.stringify(e)):localStorage.removeItem(al),!0}catch{return!1}}var kt=null;function a0(i=64){if(!pn||!Pn||nn)return null;try{let e=Math.max(8,Math.round(i)),t=Math.max(8,Math.round(e*(Jn?.clientHeight||innerHeight)/Math.max(1,Jn?.clientWidth||innerWidth)));if(!kt){let s=new tr({antialias:!1,alpha:!1,powerPreference:"low-power",precision:"highp",preserveDrawingBuffer:!0});s.outputColorSpace=St,s.toneMapping=Yi,s.toneMappingExposure=1.05,s.setPixelRatio(1),kt={renderer:s,w:0,h:0}}(kt.w!==e||kt.h!==t)&&(kt.renderer.setSize(e,t,!1),kt.w=e,kt.h=t),kt.renderer.render(pn,Pn);let n=kt.renderer.getContext(),r=new Uint8Array(e*t*4);return n.readPixels(0,0,e,t,n.RGBA,n.UNSIGNED_BYTE,r),{width:e,height:t,data:r}}catch{return null}}function o0(){if(kt){try{kt.renderer.dispose(),kt.renderer.forceContextLoss?.()}catch{}kt=null}}function Ua(){document.body.dataset.bettaBaseline=Y.targetPeriod?.baseline||Zt,document.body.dataset.bettaPeriod=Y.targetPeriod?.key||"",document.body.dataset.bettaCycleMode=Y.mode}function Sl(i,e=900,t="correction"){if(!i||!en[i.baseline])return!1;let n=or(i.baseline),r=Y.to||or(Zt);return Y.targetPeriod?.key===i.key&&Y.to&&!Y.preview||(Y.from=r,Y.to=n,Y.period=Y.targetPeriod||i,Y.targetPeriod=i,Y.t0=performance.now(),Y.duration=Math.max(0,e),Y.rawMix=e>0?0:1,Y.mix=e>0?0:1,Y.reason=t,Zt=i.baseline,Ua(),e<=0&&(Y.from=n,Y.to=n,Y.period=i,Br(n,n,1))),!0}function l0(i=performance.now()){if(Y.mode==="pin"&&Y.pin)return Y.pin;if(Y.mode==="preview"&&Y.preview){let e=(i-Y.preview.startedAt)%Y.preview.durationMs,t=(e+Y.preview.durationMs)%Y.preview.durationMs/Y.preview.durationMs;return el(t*1440)}return nl(new Date)}function zr(i=performance.now(),e=!1){let t=l0(i);if(!t||Y.targetPeriod?.key===t.key&&!e)return;let n=Y.mode==="preview"?Math.min(6e3,Y.preview.durationMs/8*.28):e?900:6e4;Sl(t,n,Y.mode==="preview"?"preview":e?"correction":"rollover")}function c0(i){if(Y.mode==="preview"&&zr(i),!Y.from||!Y.to)return;let e=Y.duration<=0?1:Kn((i-Y.t0)/Y.duration),t=Mu(e);Y.rawMix=e,Y.mix=t,Br(Y.from,Y.to,t),e>=1&&(Y.from=Y.to,Y.period=Y.targetPeriod,Y.mix=1,Y.rawMix=1)}function Wu(i){let e=Mi(i);return e?(Y.mode="pin",Y.pin=e,Y.preview=null,Sl(e,900,"developer-pin")):!1}function u0(){return Y.mode="live",Y.pin=null,Y.preview=null,zr(performance.now(),!0),Ua(),!0}function h0(i=180){let e=Math.max(3e4,Number(i||180)*1e3);return Y.mode="preview",Y.pin=null,Y.preview={startedAt:performance.now(),durationMs:e},zr(performance.now(),!0),Ua(),!0}function d0(i){let e=yi.find(n=>n.baseline===i);if(e)return Wu(e.key);if(!en[i])return!1;Y.mode="manual",Y.pin=null,Y.preview=null;let t={key:`manual-${i}`,name:en[i].name,baseline:i};return Sl(t,900,"manual-baseline")}function f0(i,e={}){let t=Mi(i);if(!t||!en[t.baseline]||Y.targetPeriod?.key!==t.key)return!1;let n=en[t.baseline],r=Y.to||or(t.baseline);for(let s of gl){let a=Number(e[s]);Number.isFinite(a)&&(n.params[s]=a,r.params[s]=a,Y.rawMix>=1&&Y.from&&(Y.from.params[s]=a))}return Y.to=r,Y.rawMix>=1&&(Y.from=r,Y.period=Y.targetPeriod,Y.mix=1,Y.rawMix=1),Br(Y.from||r,r,Y.rawMix>=1?1:Y.mix),jn(),!0}function p0(i){!Number.isFinite(i.beta)||!Number.isFinite(i.gamma)||(Pe.calibrated||(Pe.beta0=i.beta,Pe.gamma0=i.gamma,Pe.calibrated=!0),Pe.targetX=Kn((i.beta-Pe.beta0)/24,-1,1),Pe.targetY=Kn((i.gamma-Pe.gamma0)/24,-1,1),Pe.lastAt=performance.now(),Pe.enabled=!0,document.body.dataset.bettaTilt="active",jn())}async function Ru(){if(!Pe.supported)return Pe.permission="unsupported",document.body.dataset.bettaTilt="unsupported",!1;try{let i=globalThis.DeviceOrientationEvent?.requestPermission;if(typeof i=="function"){let e=await i.call(globalThis.DeviceOrientationEvent);if(Pe.permission=e,e!=="granted")return document.body.dataset.bettaTilt="denied",!1}else Pe.permission="granted";return Pe.listening||(addEventListener("deviceorientation",p0,{passive:!0}),Pe.listening=!0),Pe.calibrated=!1,Pe.targetX=Pe.targetY=Pe.currentX=Pe.currentY=0,document.body.dataset.bettaTilt="ready",!0}catch{return Pe.permission="error",document.body.dataset.bettaTilt="error",!1}}function m0(){return Pe.calibrated=!1,Pe.targetX=Pe.targetY=0,!0}function g0(i){let e=1-Math.exp(-Math.max(0,i)*.01);Pe.currentX=Mt(Pe.currentX,Pe.targetX,e),Pe.currentY=Mt(Pe.currentY,Pe.targetY,e);for(let t=0;t<ar.length;t++){let n=ar[t],r=Number(n.userData.tiltStrength)||.16,s=t?.82:1;n.rotation.x=(n.userData.baseRotationX||0)+Pe.currentX*r*s,n.rotation.y=(n.userData.baseRotationY||0)+Pe.currentY*r*s,n.rotation.z=(n.userData.baseRotationZ||0)+Pe.currentY*r*.12*s,n.position.z=(n.userData.baseZ||0)+Pe.currentX*r*.18*s}}function ml(){if(!In||!Jn||nn)return;let i=Jn.getBoundingClientRect(),e=Math.max(1,Math.round(i.width||innerWidth)),t=Math.max(1,Math.round(i.height||innerHeight));In.setSize(e,t,!1),Pn.aspect=e/t,Pn.position.z=e/t<.7?10.4:9,Pn.updateProjectionMatrix()}function _0(){La||(La=!0,document.body.classList.add("environment-ready"),document.body.dataset.bettaFirstFrame="ready",performance.mark?.("sindhorn-betta-first-frame"),document.dispatchEvent(new CustomEvent("sindhorn:betta-first-frame")))}function x0(){if(document.documentElement.dataset.startupEnter!=="pending"||matchMedia("(prefers-reduced-motion: reduce)").matches){jn();return}let i=e=>{e.propertyName==="opacity"&&(bi.removeEventListener("transitionend",i),jn())};bi.addEventListener("transitionend",i)}function Xu(i){if(Dn=0,!Ei||nn)return;let e=Math.min(50,Math.max(0,i-ol));ol=i,Eu+=e*.001*(matchMedia("(prefers-reduced-motion: reduce)").matches?.35:1),e0(e),Zg(),c0(i),g0(e);for(let t of Ti)t.uniforms.uTime.value=Eu;if($e.current==="sky"&&!Vu()&&($e.skyTime+=e*.001*(.75+.5*at.current.energy)),mn&&(mn.uniforms.uTime.value=$e.skyTime),In.render(pn,Pn),!La){_0(),x0();return}Qg(i,e),Dn=requestAnimationFrame(Xu)}function jn(){!Dn&&Ei&&!nn&&(ol=performance.now(),Dn=requestAnimationFrame(Xu))}function qu(){Dn&&(cancelAnimationFrame(Dn),Dn=0)}function v0(i){let e=at.state?.observedAt!==i.observedAt;at.status="live",at.error=null,at.state=i,at.target=cl(i.drivers),e&&(at.transitionBoost=1),document.body.dataset.bettaSatellite="live"}function y0(i){at.error=i?.message||String(i),at.state||(at.status="error"),document.body.dataset.bettaSatellite=at.state?"stale":"retrying"}function Yu(){rr||(rr=vu({onState:v0,onError:y0}))}function M0(){if(!rr)return;let i=rr;rr=null,i(),at.state&&(at.status="stale",document.body.dataset.bettaSatellite="stale")}function sr(i,e){Uu=i,Fu=e,document.body.dataset.bettaLifecycle=i,document.body.dataset.bettaLifecycleReason=e}function sl(i="background"){Ei=!1,sr(nn?"context-lost":"suspended",i),qu(),M0()}function ir(i="foreground"){if(Ei=!document.hidden,!Ei){sr(nn?"context-lost":"suspended",i);return}if(Yu(),Y.mode==="live"&&zr(performance.now(),!0),nn){sr("context-lost",i);return}sr("active",i),ml(),jn()}function S0(i){i.preventDefault(),nn=!0,qu(),sr("context-lost","webglcontextlost"),document.body.dataset.bettaContext="lost"}function b0(){nn=!1,document.body.dataset.bettaContext="restored",In?.resetState?.(),$e.current==="betta"&&vl(),ir("webglcontextrestored")}function E0(i,e){return new Promise((t,n)=>{try{let r=new tr({antialias:!1,alpha:!1,powerPreference:"high-performance",preserveDrawingBuffer:!0,precision:"highp"});r.outputColorSpace=St,r.toneMapping=Yi,r.toneMappingExposure=1.05,r.setPixelRatio(1),r.setSize(Math.max(1,Math.round(i)),Math.max(1,Math.round(e)),!1);let s=Pn.clone();s.aspect=Math.max(1,i)/Math.max(1,e),s.position.z=s.aspect<.7?10.4:9,s.updateProjectionMatrix(),r.render(pn,s);let a=r.domElement.toDataURL("image/png",1);r.dispose(),t(a)}catch(r){n(r)}})}function T0(){let i=tl(new Date);return{mode:Y.mode,timeZone:Qo,bangkokTime:i.label,periodKey:Y.period?.key||Y.targetPeriod?.key||null,periodName:Y.period?.name||Y.targetPeriod?.name||null,targetPeriodKey:Y.targetPeriod?.key||null,baseline:Y.period?.baseline||Zt,targetBaseline:Y.targetPeriod?.baseline||Zt,transitionMix:Y.mix,transitionRaw:Y.rawMix,transitionDurationMs:Y.duration,reason:Y.reason,rolloverMs:6e4,correctionMs:900,checkMs:3e4,previewDurationMs:Y.preview?.durationMs||null,periods:yi.map(e=>({...e}))}}async function _y(){if(bu)return;if(bu=!0,Jn=document.getElementById("environmentStage"),bi=document.getElementById("environmentCanvas"),!Jn||!bi||!window.WebGLRenderingContext){document.body.dataset.environmentWeather="unavailable";return}r0();let i=nl(new Date);Zt=i.baseline,$n=or(Zt),Y.period=i,Y.targetPeriod=i,Y.from=$n,Y.to=$n,pn=new Tr,Pn=new wt(32,1,.1,50),Pn.position.set(0,0,9),In=new tr({canvas:bi,antialias:!1,alpha:!1,powerPreference:"high-performance",precision:"highp",preserveDrawingBuffer:!1}),In.outputColorSpace=St,In.toneMapping=Yi,In.toneMappingExposure=1.05,In.setPixelRatio(Su);let[e,t]=zu();$e.current=e,$e.reason=t,document.body.dataset.bettaMode=e,document.body.dataset.bettaModeReason=t,xl.addEventListener?.("change",Ml),Jn.hidden=!1,ml(),pn.background=Je("#010103"),Gg($n),$e.current==="betta"&&vl(),Ua(),document.body.dataset.bettaFirstFrame="pending",document.body.dataset.environmentRenderer="sindhorn-betta-satellite-v1",document.body.dataset.environmentInput="satellite-only",document.body.dataset.bettaBaselineAuthority="bangkok-day-cycle",document.body.dataset.bettaContext="active",document.body.dataset.bettaTilt=Pe.supported?"available":"unsupported",sr(Ei?"active":"suspended","initial"),Pe.supported&&typeof globalThis.DeviceOrientationEvent?.requestPermission!="function"&&Ru().catch(()=>{}),new ResizeObserver(()=>ml()).observe(Jn),document.addEventListener("visibilitychange",()=>{document.hidden?sl("visibilitychange"):ir("visibilitychange")}),addEventListener("pagehide",()=>sl("pagehide")),addEventListener("pageshow",()=>ir("pageshow")),addEventListener("focus",()=>ir("focus")),document.addEventListener("freeze",()=>sl("freeze")),document.addEventListener("resume",()=>ir("resume")),bi.addEventListener("webglcontextlost",S0,!1),bi.addEventListener("webglcontextrestored",b0,!1),document.addEventListener("sindhorn:route-mounted",ul),document.addEventListener("sindhorn:location-updated",()=>Da().catch(()=>{})),Yu(),window.SindhornEnvironment={refreshWeather:()=>Da().catch(()=>pt),renderExport:E0,setBettaBaseline:d0,setBettaPeriod:Wu,useLiveBettaDayCycle:u0,previewBettaDayCycle:h0,previewBettaComposition:f0,setBettaStyle:n0,setBettaStyles:i0,saveBettaStyles:s0,sampleBettaFrame:a0,disposeBettaSampler:o0,setBettaMode:jg,setBettaPreference:Kg,enableBettaTilt:Ru,recenterBettaTilt:m0,getState:()=>({weather:{...pt,visual:Og(pt)},air:{...window.SindhornLiveData?.getState?.().air||{}},solar:null,lunar:null,location:{...window.SindhornLocation?.getState?.()||{}},quality:Su,config:null,seasonal:null,renderer:"sindhorn-betta-satellite-v1",inputMode:"satellite-only",betta:{mode:$e.current,modeReason:$e.reason,modeRequested:$e.requested,preference:yl(),skyHeld:Vu(),frameMs:$e.frameMs,baseline:Y.targetPeriod?.baseline||Zt,baselineAuthority:"bangkok-day-cycle",availableBaselines:[...Lu],dayCycle:T0(),styles:Gu(),satelliteSource:yu,satelliteStatus:at.status,observedAt:at.state?.observedAt||null,metrics:at.state?.metrics?{...at.state.metrics}:null,lifecycle:Uu,lifecycleReason:Fu,contextLost:nn,satelliteStreaming:!!rr,rendering:!!Dn,firstFrameRendered:La,tilt:{supported:Pe.supported,enabled:Pe.enabled,listening:Pe.listening,permission:Pe.permission,calibrated:Pe.calibrated,x:Pe.currentX,y:Pe.currentY}}}),applyConfig:()=>{}},jn(),Da().catch(()=>{}),setInterval(()=>Da().catch(()=>{}),600*1e3),setInterval(()=>{Y.mode==="live"&&!document.hidden&&zr(performance.now())},3e4),setInterval(()=>{!document.hidden&&!nn&&!Dn&&ir("watchdog")},2e3)}export{_y as initEnvironment};
