...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function Mc(){return new Ut({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Oo(),fragmentShader:`
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function Sc(){return new Ut({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Oo(),fragmentShader:`
...
`)}function em(i,e){let t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){let s=i.getActiveAttrib(e,r),a=s.name,o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Er(i){return i!==""}function Lc(i,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Uc(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var tm=/^[ \t]*#include +<([\w\d./]+)>/gm;function Do(i){return i.replace(tm,im)}var nm=new Map;function im(i,e){let t=Ne[e];if(t===void 0){let n=nm.get(e);if(n!==void 0)t=Ne[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Do(t)}var rm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Fc(i){return i.replace(rm,sm)}function sm(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Nc(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function am(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===to?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Al?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===sn&&(e="SHADOWMAP_TYPE_VSM"),e}function om(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ei:case ti:e="ENVMAP_TYPE_CUBE";break;case _r:e="ENVMAP_TYPE_CUBE_UV";break}return e}function lm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ti:e="ENVMAP_MODE_REFRACTION";break}return e}function cm(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case so:e="ENVMAP_BLENDING_MULTIPLY";break;case ql:e="ENVMAP_BLENDING_MIX";break;case Yl:e="ENVMAP_BLENDING_ADD";break}return e}function hm(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function um(i,e,t,n){let r=i.getContext(),s=t.defines,a=t.vertexShader,o=t.fragmentShader,c=am(t),l=om(t),h=lm(t),u=cm(t),f=hm(t),p=Qp(t),_=jp(s),v=r.createProgram(),m,d,w=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Er).join(`
`)),a=Do(a),a=Lc(a,t),a=Uc(a,t),o=Do(o),o=Lc(o,t),o=Uc(o,t),a=Fc(a),o=Fc(o),t.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+d);let E=w+m+a,M=w+d+o,A=Ic(r,r.VERTEX_SHADER,E),C=Ic(r,r.FRAGMENT_SHADER,M);r.attachShader(v,A),r.attachShader(v,C),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function I(P){if(i.debug.checkShaderErrors){let z=r.getProgramInfoLog(v)||"",H=r.getShaderInfoLog(A)||"",X=r.getShaderInfoLog(C)||"",Z=z.trim(),W=H.trim(),te=X.trim(),k=!0,ae=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(k=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,v,A,C);else{let he=Dc(r,A,"vertex"),be=Dc(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
`;var Jc="/api/betta-satellite",zo={lat:13.7563,lon:100.5018},Jt={west:99,east:110,north:16,south:7},$c="Himawari-9 \xB7 JMA High-Resolution Asia 1",ht=(i,e=0,t=1)=>Math.min(t,Math.max(e,i)),_a=(i,e,t)=>i+(e-i)*t;function ko(i){if(i instanceof Date)return i;let e=String(i||"").trim().replace(" ","T");return new Date(/[zZ]|[+-]\d\d:?\d\d$/.test(e)?e:`${e}Z`)}function Yc(i){return String(i).padStart(2,"0")}function Nm(i){let e=ko(i);if(!Number.isFinite(e.getTime()))throw new Error("Invalid Himawari timestamp");return`${Yc(e.getUTCHours())}${Yc(Math.floor(e.getUTCMinutes()/10)*10)}`}function Om(i){let e=ko(i);return new Date(e.getTime()-600*1e3)}function Bm(i,e){let t=new URLSearchParams({kind:"frame",band:i,time:Nm(e)});return`${Jc}?${t}`}async function xa(i,e){let t=await fetch(Bm(i,e),{cache:"no-store"});if(!t.ok)throw new Error(`${i} Himawari frame ${t.status}`);let n=await t.blob(),r=await createImageBitmap(n),s=document.createElement("canvas");s.width=r.width,s.height=r.height;let a=s.getContext("2d",{willReadFrequently:!0});if(!a)throw new Error("Satellite analysis canvas unavailable");return a.drawImage(r,0,0),r.close?.(),a.getImageData(0,0,s.width,s.height)}function zm(i){let e=ht((zo.lon-Jt.west)/(Jt.east-Jt.west)),t=ht((Jt.north-zo.lat)/(Jt.north-Jt.south));return{x:e*(i.width-1),y:t*(i.height-1),xNorm:e,yNorm:t}}function va(i,e=.72){let t=zm(i),n=Math.max(18,Math.round(i.width*e/(Jt.east-Jt.west))),r=Math.max(18,Math.round(i.height*e/(Jt.north-Jt.south))),s=Math.round(t.x),a=Math.round(t.y),o=Math.max(1,s-n),c=Math.min(i.width-2,s+n),l=Math.max(1,a-r),h=Math.min(i.height-2,a+r),u=c-o+1,f=h-l+1;if(u<12||f<12)throw new Error("Bangkok satellite patch too small");let p=new Float32Array(u*f),_=new Float32Array(u*f*3),v=0,m=0;for(let d=l;d<=h;d++)for(let w=o;w<=c;w++){let E=(d*i.width+w)*4,M=i.data[E]/255,A=i.data[E+1]/255,C=i.data[E+2]/255;p[v++]=M*.2126+A*.7152+C*.0722,_[m++]=M,_[m++]=A,_[m++]=C}return{gray:p,rgb:_,width:u,height:f,left:o,top:l,sourceWidth:i.width,sourceHeight:i.height,centerX:t.x,centerY:t.y,radiusDegrees:e}}function km(i){let e=0;for(let t=0;t<i.length;t++)e+=i[t];return i.length?e/i.length:0}function Zc(i){if(!i.length)return 0;let e=km(i),t=0;for(let n=0;n<i.length;n++){let r=i[n]-e;t+=r*r}return Math.sqrt(t/i.length)}function Vn(i,e){if(!i.length)return 0;let t=Array.from(i).sort((n,r)=>n-r);return t[Math.min(t.length-1,Math.max(0,Math.floor((t.length-1)*e)))]}function Kc(i){let{gray:e,width:t,height:n}=i;if(t<3||n<3)return 0;let r=0,s=0;for(let a=1;a<n-1;a+=2)for(let o=1;o<t-1;o+=2){let c=a*t+o,l=e[c+1]-e[c-1],h=e[c+t]-e[c-t];r+=Math.sqrt(l*l+h*h),s++}return s?r/s:0}function Vm(i,e){let t=Vn(i.gray,.3),n=Vn(i.gray,.7),r=Vn(i.gray,.9),s=Vn(i.gray,.97),a=Vn(e.gray,.7),o=Vn(e.gray,.9),c=Math.max(.025,s-t),l=t+c*.43,h=0;for(let v=0;v<i.gray.length;v++)i.gray[v]>l&&h++;let u=ht(h/Math.max(1,i.gray.length)),f=ht((r-t)/Math.max(.08,c)),p=ht((r-o)*3.2+(n-a)*2.1,-1,1),_=ht(Kc(i)/.14);return{cloudAmount:u,coldCloud:f,cooling:p,texture:_,p30:t,p70:n,p90:r,p97:s}}function Hm(i,e){let t=Math.min(i.width,e.width),n=Math.min(i.height,e.height),r=Math.max(2,Math.min(9,Math.floor(Math.min(t,n)/10))),s=r+3,a={score:-2,dx:0,dy:0};for(let l=-r;l<=r;l++)for(let h=-r;h<=r;h++){let u=0,f=0,p=0;for(let M=s;M<n-s;M+=2)for(let A=s;A<t-s;A+=2)u+=i.gray[M*i.width+A],f+=e.gray[(M-l)*e.width+(A-h)],p++;if(!p)continue;let _=u/p,v=f/p,m=0,d=0,w=0;for(let M=s;M<n-s;M+=2)for(let A=s;A<t-s;A+=2){let C=i.gray[M*i.width+A]-_,I=e.gray[(M-l)*e.width+(A-h)]-v;m+=C*I,d+=C*C,w+=I*I}let E=m/Math.sqrt(Math.max(1e-8,d*w));E>a.score&&(a={score:E,dx:h,dy:l})}let o=Math.sqrt(a.dx*a.dx+a.dy*a.dy),c=ht((a.score-.18)/.67);return{dx:a.dx,dy:a.dy,correlation:a.score,confidence:c,magnitude:o,energy:ht(o/6)*c}}function Gm(i){let e=Vn(i.gray,.72),t=Vn(i.gray,.25),n=ht(Kc(i)/.15),r=ht((e-t)/.42)*.68+n*.32;return{moisture:ht(r),texture:n,p25:t,p72:e}}function Wm(i){let e=0,t=0,n=0,r=0,s=0,a=0;for(let _=0;_<i.gray.length;_++){let v=i.gray[_];if(v>.025){let m=_*3;e+=i.rgb[m],t+=i.rgb[m+1],n+=i.rgb[m+2],r+=v,a++}s++}if(!a)return{confidence:0,color:[.16,.22,.52],meanLuma:0};e/=a,t/=a,n/=a,r/=a;let o=ht((r-.035)/.17)*ht(a/Math.max(1,s)*1.8),c=Math.max(e,t,n),l=Math.min(e,t,n),h=c-l,u=h>.01?Math.min(2.2,.28/h):1,f=(e+t+n)/3,p=[ht(f+(e-f)*u),ht(f+(t-f)*u),ht(f+(n-f)*u)];return{confidence:o,color:p,meanLuma:r}}function Xm(...i){let e=2166136261;for(let s of i){let a=s.gray,o=Math.max(1,Math.floor(a.length/421));for(let c=0;c<a.length;c+=o)e^=Math.round(a[c]*255)&255,e=Math.imul(e,16777619)>>>0}let t=(e&65535)/65535,n=(e>>>8&65535)/65535,r=(e>>>16&65535)/65535;return{hash:e.toString(16).padStart(8,"0"),a:t,b:n,c:r}}function qm({latest:i,currentIR:e,previousIR:t,waterVapor:n,visible:r}){let s=Zc(e.gray),a=Zc(n.gray);if(s<.006||a<.004)throw new Error(`Degenerate Himawari Bangkok patch (IR ${s.toFixed(4)}, WV ${a.toFixed(4)})`);let o=Vm(e,t),c=Hm(e,t),l=Gm(n),h=Wm(r),u=Xm(e,n),f=Math.max(0,o.cooling),p=ht(.62+c.energy*.2+o.texture*.13+o.coldCloud*.08+f*.18,.62,1),_=Math.atan2(-c.dy,c.dx),v=(u.a*2-1)*Math.PI,m=_a(v,_,c.confidence),d=.5+p*.55,w=[Math.cos(m)*d,Math.sin(m)*d],E=[ht(.16+.48*o.coldCloud+.16*u.c),ht(.15+.48*l.moisture+.14*u.b),ht(.4+.4*(1-o.coldCloud)+.18*u.a)],M=[_a(E[0],h.color[0],h.confidence*.7),_a(E[1],h.color[1],h.confidence*.7),_a(E[2],h.color[2],h.confidence*.7)];return{status:"live",inputMode:"satellite-only",satellite:"Himawari-9",provider:"JMA",source:$c,sector:i.sector||"High-Resolution Asia 1",bounds:i.bounds||Jt,observedAt:i.observedAt||i.date,sourceLastModified:i.sourceLastModified||null,cadenceMinutes:i.cadenceMinutes||10,bangkok:{...zo,imageWidth:e.sourceWidth,imageHeight:e.sourceHeight,pixelX:+e.centerX.toFixed(1),pixelY:+e.centerY.toFixed(1),radiusDegrees:e.radiusDegrees},metrics:{cloudAmount:+o.cloudAmount.toFixed(3),coldCloud:+o.coldCloud.toFixed(3),cooling:+o.cooling.toFixed(3),cloudTexture:+o.texture.toFixed(3),waterVapor:+l.moisture.toFixed(3),motionX:c.dx,motionY:c.dy,motionMagnitude:+c.magnitude.toFixed(3),motionConfidence:+c.confidence.toFixed(3),visibleConfidence:+h.confidence.toFixed(3),energy:+p.toFixed(3),fingerprint:u.hash,irVariation:+s.toFixed(4),vaporVariation:+a.toFixed(4)},drivers:{energy:p,cloud:o.cloudAmount,cold:o.coldCloud,cooling:o.cooling,texture:o.texture,vapor:l.moisture,motion:w,color:M,visible:h.confidence,fingerprint:[u.a,u.b,u.c]}}}async function Ym(){let i=await fetch(`${Jc}?kind=latest`,{cache:"no-store"});if(!i.ok)throw new Error(`Himawari metadata ${i.status}`);let e=await i.json();if(!e?.ok||!(e.observedAt||e.date))throw new Error(e?.error||"Himawari metadata unavailable");return e}async function Zm(i){let e=ko(i.observedAt||i.date),t=Om(e),[n,r,s,a]=await Promise.all([xa("b13",e),xa("b13",t),xa("b08",e),xa("b03",e)]);return{currentIR:va(n),previousIR:va(r),waterVapor:va(s),visible:va(a)}}async function Jm(){let i=await Ym(),e=await Zm(i);return qm({latest:i,...e})}function Qc({onState:i,onError:e,intervalMs:t=9e4}={}){let n=!1,r="";async function s(){try{let o=await Jm();if(n)return;o.observedAt!==r&&(r=o.observedAt,i?.(o))}catch(o){n||e?.(o)}}s();let a=setInterval(s,Math.max(3e4,t));return()=>{n=!0,clearInterval(a)}}var jc=$c;var Vo="Asia/Bangkok";var zi=Object.freeze([Object.freeze({key:"midnight",startHour:0,endHour:3,name:"Midnight",baseline:"blackOrchid",tone:"dark"}),Object.freeze({key:"before-dawn",startHour:3,endHour:6,name:"Before Dawn",baseline:"copperMetallic",tone:"dark"}),Object.freeze({key:"first-light",startHour:6,endHour:9,name:"First Light",baseline:"turquoiseMetallic",tone:"bright"}),Object.freeze({key:"bright-morning",startHour:9,endHour:12,name:"Bright Morning",baseline:"royalBlueHalfmoon",tone:"bright"}),Object.freeze({key:"midday",startHour:12,endHour:15,name:"Midday",baseline:"redSnowDragon",tone:"bright"}),Object.freeze({key:"afternoon",startHour:15,endHour:18,name:"Afternoon",baseline:"mustardGas",tone:"bright"}),Object.freeze({key:"golden-hour",startHour:18,endHour:21,name:"Golden Hour",baseline:"nemoGalaxyKoi",tone:"dark"}),Object.freeze({key:"blue-hour",startHour:21,endHour:24,name:"Blue Hour",baseline:"superRedHalfmoon",tone:"dark"})]),$m=i=>Math.min(1,Math.max(0,Number(i)||0)),Km=new Intl.DateTimeFormat("en-GB",{timeZone:Vo,hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}),eh=i=>1-Math.pow(1-$m(i),3);function Ho(i){let e=((Number(i)||0)%1440+1440)%1440,t=e/60;return zi.find(n=>t>=n.startHour&&t<n.endHour)||zi[0]}function Go(i=new Date){let e=Object.fromEntries(Km.formatToParts(i).filter(s=>s.type!=="literal").map(s=>[s.type,s.value])),t=Number(e.hour)||0,n=Number(e.minute)||0,r=Number(e.second)||0;return{hour:t,minute:n,second:r,minuteOfDay:t*60+n+r/60,label:`${String(t).padStart(2,"0")}:${String(n).padStart(2,"0")}:${String(r).padStart(2,"0")}`}}function Wo(i=new Date){return Ho(Go(i).minuteOfDay)}function th(i){return zi.find(e=>e.key===i)||null}var nh=2,oi=72,Qm="https://api.open-meteo.com/v1/forecast?latitude=13.74135&longitude=100.54274&current=temperature_2m,apparent_temperature,relative_humidity_2m,precipitation,rain,showers,snowfall,weather_code,cloud_cover,wind_speed_10m,wind_direction_10m,wind_gusts_10m,visibility,is_day&timezone=Asia%2FBangkok",ch="sindhorn-midtown:weather:v2",jm=2700*1e3,hh=Object.freeze(Object.keys(kn)),eg=Math.max(...hh.map(i=>kn[i].params.rayCount)),Wi=(i,e=0,t=1)=>Math.min(t,Math.max(e,Number(i)||0)),Gt=(i,e,t)=>i+(e-i)*t,tg=(i,e,t)=>{let n=(e-i)%(Math.PI*2);return n>Math.PI&&(n-=Math.PI*2),n<-Math.PI&&(n+=Math.PI*2),i+n*t},ih=!1,Vi=null,wr=null,En=null,qi=null,li=null,Xo=null,Tn=0,rh=0,Yo=performance.now(),Zo=!1,Kt=ga,ci=Bo(ga),Hi=null,hi=!document.hidden,uh=hi?"active":"suspended",cn=!1,dh="initial",Ma=[],Xi=[],ut={known:!1,cached:!1,cloudCover:0,precipitationMm:0,rainMm:0,showersMm:0,snowfallCm:0,humidity:.68,windSpeedKmh:4,windDirectionDeg:180,windGustKmh:null,visibilityKm:20,temperatureC:null,apparentTemperatureC:null,weatherCode:null,isDay:null,observedAt:null},sh={energy:.58,cloud:.35,cold:.35,cooling:0,texture:.32,vapor:.42,motion:[0,0],color:[.18,.23,.52],visible:0,fingerprint:[.5,.5,.5]},Jo=i=>({energy:i.energy,cloud:i.cloud,cold:i.cold,cooling:i.cooling,texture:i.texture,vapor:i.vapor,motion:[...i.motion],color:[...i.color],visible:i.visible,fingerprint:[...i.fingerprint]}),$e={status:"loading",state:null,error:null,current:Jo(sh),target:Jo(sh),transitionBoost:0},ne={mode:"live",period:null,targetPeriod:null,from:null,to:null,t0:0,duration:0,mix:1,rawMix:1,reason:"initial",pin:null,preview:null},ng=new Set([51,53,55,56,57,61,63,65,66,67,80,81,82,95,96,99]),ig=new Set([51,53,55,56,57]),fh=new Set([95,96,99]);function ph(i){let e=Number(i);return e===0?"Clear":e===1?"Mainly clear":e===2?"Partly cloudy":e===3?"Overcast":[45,48].includes(e)?"Fog":ig.has(e)?"Drizzle":[61,63,65,66,67].includes(e)?"Rain":[71,73,75,77].includes(e)?"Snow":[80,81,82].includes(e)?"Rain showers":[85,86].includes(e)?"Snow showers":fh.has(e)?"Thunderstorm":"Current weather"}function rg(i){return["N","NE","E","SE","S","SW","W","NW"][Math.round(((Number(i)||0)%360+360)%360/45)%8]}function sg(i){let e=Number(i.weatherCode),t=Wi(i.cloudCover),n=Math.max(0,Number(i.precipitationMm)||0),r=Math.max(n,Number(i.rainMm)||0,Number(i.showersMm)||0);return{cloud:t,rain:Wi(Math.max(ng.has(e)?.35:0,r/8)),storm:fh.has(e)?1:0,type:ph(e).toLowerCase().replaceAll(" ","-")}}function $o(){let i=document.getElementById("weatherNow");if(!i||!ut.known||!Number.isFinite(ut.temperatureC))return;let e=Number.isFinite(ut.apparentTemperatureC)?Math.round(ut.apparentTemperatureC):Math.round(ut.temperatureC),t=(n,r)=>{let s=document.getElementById(n);s&&(s.textContent=r)};t("weatherTemp",`${Math.round(ut.temperatureC)}\xB0`),t("weatherConditionEn",ph(ut.weatherCode)),t("weatherMetaEn",`Feels ${e}\xB0 \xB7 RH ${Math.round(ut.humidity*100)}% \xB7 Wind ${rg(ut.windDirectionDeg)} ${Math.round(ut.windSpeedKmh)} km/h`),i.hidden=!1}function ag(){try{let i=JSON.parse(localStorage.getItem(ch)||"null");return!i||!i.savedAt||Date.now()-i.savedAt>jm?null:i.value||null}catch{return null}}function og(i){try{localStorage.setItem(ch,JSON.stringify({savedAt:Date.now(),value:i}))}catch{}}async function ya(){let i=ag();i&&!ut.known&&(Object.assign(ut,i,{known:!0,cached:!0}),$o());let e=await fetch(Qm,{cache:"no-store",credentials:"omit"});if(!e.ok)throw new Error("weather "+e.status);let t=await e.json(),n=t.current||{},r=(s,a=null)=>Number.isFinite(Number(s))?Number(s):a;return Object.assign(ut,{known:!0,cached:!1,cloudCover:Wi(r(n.cloud_cover,0)/100),precipitationMm:Math.max(0,r(n.precipitation,0)),rainMm:Math.max(0,r(n.rain,0)),showersMm:Math.max(0,r(n.showers,0)),snowfallCm:Math.max(0,r(n.snowfall,0)),humidity:Wi(r(n.relative_humidity_2m,68)/100),windSpeedKmh:Math.max(0,r(n.wind_speed_10m,4)),windDirectionDeg:(r(n.wind_direction_10m,180)%360+360)%360,windGustKmh:r(n.wind_gusts_10m),visibilityKm:Math.max(.1,r(n.visibility,2e4)/1e3),temperatureC:r(n.temperature_2m),apparentTemperatureC:r(n.apparent_temperature),weatherCode:r(n.weather_code),isDay:r(n.is_day),observedAt:n.time||null}),og(ut),$o(),document.dispatchEvent(new CustomEvent("sindhorn:weather-updated",{detail:{weatherCode:ut.weatherCode,precipitationMm:ut.precipitationMm}})),ut}function $t(i){return new Ve(i)}function lg(i){let e=Math.max(32,Math.min(80,Math.round(i/4)*4)),t=(e+1)*(oi+1),n=new Float32Array(t*3),r=new Float32Array(t),s=new Float32Array(t),a=new Float32Array(t),o=[],c=[];for(let h=0;h<=e;h++){let u=h/e,f=Math.sin((h+1)*12.9898+78.233)*43758.5453,p=Math.sin((h+7)*4.123+21.731)*15731.743;c[h]=(f-Math.floor(f)-.5)*1.4+(p-Math.floor(p)-.5)*.6;for(let _=0;_<=oi;_++){let v=h*(oi+1)+_;r[v]=_/oi,s[v]=u,a[v]=c[h]}}for(let h=0;h<e;h++)for(let u=0;u<oi;u++){let f=h*(oi+1)+u,p=f+oi+1;o.push(f,p,f+1,p,p+1,f+1)}let l=new rn;return l.setAttribute("position",new _t(n,3)),l.setAttribute("aU",new _t(r,1)),l.setAttribute("aV",new _t(s,1)),l.setAttribute("aRayJitter",new _t(a,1)),l.setIndex(o),l.computeBoundingSphere(),l}function Ko(i,e){let t=i.layers[e],n=i.layers[0]||{};return t?{seed:t.seed??0,phase:t.phase||0,scale:t.scale||1,rotation:t.rotation||0,offset:[...t.offset||[0,0,0]],alpha:t.alpha??1}:{seed:(n.seed||0)+13.37*(e+1),phase:(n.phase||0)+11.9*(e+1),scale:n.scale||1,rotation:n.rotation||0,offset:[...n.offset||[0,0,0]],alpha:0}}function ah(i,e,t){i[e].value.copy($t(t))}function cg(i,e){let t=e.params,n=$e.current,r=Ko(e,i);return new Ut({vertexShader:Xc,fragmentShader:qc,transparent:!0,depthTest:!0,depthWrite:!1,side:Vt,blending:xn,uniforms:{uTime:{value:0},uSeed:{value:r.seed},uPhase:{value:r.phase},uSpread:{value:t.spread},uFoldDensity:{value:t.foldDensity},uCurl:{value:t.curl},uTwist:{value:t.twist},uEdgeFlutter:{value:t.edgeFlutter},uDepth:{value:t.depth},uCurrentStrength:{value:t.currentStrength},uMotionSpeed:{value:t.motionSpeed},uTurbulence:{value:t.turbulence},uMotionAmplitude:{value:t.motionAmplitude},uCurrent:{value:new We(n.motion[0],n.motion[1])},uOpacity:{value:t.opacity},uTransmission:{value:t.transmission},uRimStrength:{value:t.rimStrength},uFoldHighlight:{value:t.foldHighlight},uIridescence:{value:t.iridescence},uBloom:{value:t.bloom},uSaturation:{value:t.saturation},uBrightness:{value:t.brightness},uGradientPosition:{value:t.gradientPosition},uLayerAlpha:{value:r.alpha},uMorphModeFrom:{value:e.morphMode||0},uMorphModeTo:{value:e.morphMode||0},uMorphTransition:{value:1},uColor0From:{value:$t(e.palette[0])},uColor1From:{value:$t(e.palette[1])},uColor2From:{value:$t(e.palette[2])},uColor3From:{value:$t(e.palette[3])},uColor0To:{value:$t(e.palette[0])},uColor1To:{value:$t(e.palette[1])},uColor2To:{value:$t(e.palette[2])},uColor3To:{value:$t(e.palette[3])},uSatelliteEnergy:{value:n.energy},uSatelliteCloud:{value:n.cloud},uSatelliteCold:{value:n.cold},uSatelliteCooling:{value:n.cooling},uSatelliteTexture:{value:n.texture},uSatelliteVapor:{value:n.vapor},uSatelliteVisible:{value:n.visible},uSatelliteMotion:{value:new We(n.motion[0],n.motion[1])},uSatelliteColor:{value:new N(...n.color)},uSatelliteFingerprint:{value:new N(...n.fingerprint)}}})}function hg(){for(let i of Ma)qi.remove(i);for(let i of Xi)i.dispose();Ma.length=0,Xi.length=0}function mh(){hg(),Xo?.dispose(),Xo=lg(eg);for(let i=0;i<2;i++){let e=cg(i,ci),t=new Ct(Xo,e);t.renderOrder=i,t.frustumCulled=!1,qi.add(t),Ma.push(t),Xi.push(e)}el(ci,ci,1)}function ug(i,e,t,n){return Gt(i.params[t],e.params[t],n)}function el(i,e,t){let n=Wi(t),r=$t(i.background),s=$t(e.background);ci=e,Kt=n>=1&&(ne.targetPeriod?.baseline||e.__key)||Kt;for(let c=0;c<2;c++){let l=Xi[c],h=Ma[c],u=l.uniforms,f=Ko(i,c),p=Ko(e,c);for(let v of["spread","foldDensity","curl","twist","edgeFlutter","depth","currentStrength","motionSpeed","turbulence","motionAmplitude","opacity","transmission","rimStrength","foldHighlight","iridescence","bloom","saturation","brightness","gradientPosition"])u["u"+v[0].toUpperCase()+v.slice(1)].value=ug(i,e,v,n);u.uSeed.value=Gt(f.seed,p.seed,n),u.uPhase.value=Gt(f.phase,p.phase,n),u.uLayerAlpha.value=Gt(f.alpha,p.alpha,n),u.uMorphModeFrom.value=i.morphMode||0,u.uMorphModeTo.value=e.morphMode||0,u.uMorphTransition.value=n;for(let v=0;v<4;v++)ah(u,`uColor${v}From`,i.palette[v]),ah(u,`uColor${v}To`,e.palette[v]);let _=Gt(i.params.scale*(f.scale||1),e.params.scale*(p.scale||1),n);h.scale.setScalar(_),h.rotation.z=tg(i.params.rotation+(f.rotation||0),e.params.rotation+(p.rotation||0),n),h.position.set(Gt(i.params.offsetX+(f.offset[0]||0),e.params.offsetX+(p.offset[0]||0),n),Gt(i.params.offsetY+(f.offset[1]||0),e.params.offsetY+(p.offset[1]||0),n),Gt(i.params.cameraDepth+(f.offset[2]||0),e.params.cameraDepth+(p.offset[2]||0),n))}let a=new Ve($e.current.color[0],$e.current.color[1],$e.current.color[2]),o=r.lerp(s,n);qi.background=o.lerp(a,.025+.025*$e.current.cloud+.018*$e.current.visible)}function dg(){let i=$e.current;for(let e of Xi){let t=e.uniforms;t.uCurrent.value.set(i.motion[0],i.motion[1]),t.uSatelliteEnergy.value=i.energy,t.uSatelliteCloud.value=i.cloud,t.uSatelliteCold.value=i.cold,t.uSatelliteCooling.value=i.cooling,t.uSatelliteTexture.value=i.texture,t.uSatelliteVapor.value=i.vapor,t.uSatelliteVisible.value=i.visible,t.uSatelliteMotion.value.set(i.motion[0],i.motion[1]),t.uSatelliteColor.value.set(i.color[0],i.color[1],i.color[2]),t.uSatelliteFingerprint.value.set(i.fingerprint[0],i.fingerprint[1],i.fingerprint[2])}}function fg(i){let e=i*.001,t=$e.transitionBoost,n=1-Math.exp(-e*(.13+t*.22)),r=$e.current,s=$e.target;for(let a of["energy","cloud","cold","cooling","texture","vapor","visible"])r[a]=Gt(r[a],s[a],n);for(let a=0;a<2;a++)r.motion[a]=Gt(r.motion[a],s.motion[a],n);for(let a=0;a<3;a++)r.color[a]=Gt(r.color[a],s.color[a],n),r.fingerprint[a]=Gt(r.fingerprint[a],s.fingerprint[a],n);$e.transitionBoost=Math.max(0,t-e*.055)}function Qo(i){let e=Bo(i);return e.__key=i,e}function Sa(){document.body.dataset.bettaBaseline=ne.targetPeriod?.baseline||Kt,document.body.dataset.bettaPeriod=ne.targetPeriod?.key||"",document.body.dataset.bettaCycleMode=ne.mode}function tl(i,e=900,t="correction"){if(!i||!kn[i.baseline])return!1;let n=Qo(i.baseline),r=ne.to||Qo(Kt);return ne.targetPeriod?.key===i.key&&ne.to&&!ne.preview||(ne.from=r,ne.to=n,ne.period=ne.targetPeriod||i,ne.targetPeriod=i,ne.t0=performance.now(),ne.duration=Math.max(0,e),ne.rawMix=e>0?0:1,ne.mix=e>0?0:1,ne.reason=t,Kt=i.baseline,Sa(),e<=0&&(ne.from=n,ne.to=n,ne.period=i,el(n,n,1))),!0}function pg(i=performance.now()){if(ne.mode==="pin"&&ne.pin)return ne.pin;if(ne.mode==="preview"&&ne.preview){let e=(i-ne.preview.startedAt)%ne.preview.durationMs,t=(e+ne.preview.durationMs)%ne.preview.durationMs/ne.preview.durationMs;return Ho(t*1440)}return Wo(new Date)}function Cr(i=performance.now(),e=!1){let t=pg(i);if(!t||ne.targetPeriod?.key===t.key&&!e)return;let n=ne.mode==="preview"?Math.min(6e3,ne.preview.durationMs/8*.28):e?900:6e4;tl(t,n,ne.mode==="preview"?"preview":e?"correction":"rollover")}function mg(i){if(ne.mode==="preview"&&Cr(i),!ne.from||!ne.to)return;let e=ne.duration<=0?1:Wi((i-ne.t0)/ne.duration),t=eh(e);ne.rawMix=e,ne.mix=t,el(ne.from,ne.to,t),e>=1&&(ne.from=ne.to,ne.period=ne.targetPeriod,ne.mix=1,ne.rawMix=1)}function gh(i){let e=th(i);return e?(ne.mode="pin",ne.pin=e,ne.preview=null,tl(e,900,"developer-pin")):!1}function gg(){return ne.mode="live",ne.pin=null,ne.preview=null,Cr(performance.now(),!0),Sa(),!0}function _g(i=180){let e=Math.max(3e4,Number(i||180)*1e3);return ne.mode="preview",ne.pin=null,ne.preview={startedAt:performance.now(),durationMs:e},Cr(performance.now(),!0),Sa(),!0}function xg(i){let e=zi.find(n=>n.baseline===i);if(e)return gh(e.key);if(!kn[i])return!1;ne.mode="manual",ne.pin=null,ne.preview=null;let t={key:`manual-${i}`,name:kn[i].name,baseline:i};return tl(t,900,"manual-baseline")}function jo(){if(!En||!Vi||cn)return;let i=Vi.getBoundingClientRect(),e=Math.max(1,Math.round(i.width||innerWidth)),t=Math.max(1,Math.round(i.height||innerHeight));En.setSize(e,t,!1),li.aspect=e/t,li.position.z=e/t<.7?10.4:9,li.updateProjectionMatrix()}function vg(){Zo||(Zo=!0,document.body.classList.add("environment-ready"),document.body.dataset.bettaFirstFrame="ready",performance.mark?.("sindhorn-betta-first-frame"),document.dispatchEvent(new CustomEvent("sindhorn:betta-first-frame")))}function _h(i){if(Tn=0,!hi||cn)return;let e=Math.min(50,Math.max(0,i-Yo));Yo=i,rh+=e*.001*(matchMedia("(prefers-reduced-motion: reduce)").matches?.35:1),fg(e),dg(),mg(i);for(let t of Xi)t.uniforms.uTime.value=rh;En.render(qi,li),vg(),Tn=requestAnimationFrame(_h)}function xh(){!Tn&&hi&&!cn&&(Yo=performance.now(),Tn=requestAnimationFrame(_h))}function vh(){Tn&&(cancelAnimationFrame(Tn),Tn=0)}function yg(i){let e=$e.state?.observedAt!==i.observedAt;$e.status="live",$e.error=null,$e.state=i,$e.target=Jo(i.drivers),e&&($e.transitionBoost=1),document.body.dataset.bettaSatellite="live"}function Mg(i){$e.error=i?.message||String(i),$e.state||($e.status="error"),document.body.dataset.bettaSatellite=$e.state?"stale":"retrying"}function yh(){Hi||(Hi=Qc({onState:yg,onError:Mg}))}function Sg(){if(!Hi)return;let i=Hi;Hi=null,i(),$e.state&&($e.status="stale",document.body.dataset.bettaSatellite="stale")}function Gi(i,e){uh=i,dh=e,document.body.dataset.bettaLifecycle=i,document.body.dataset.bettaLifecycleReason=e}function qo(i="background"){hi=!1,Gi(cn?"context-lost":"suspended",i),vh(),Sg()}function ki(i="foreground"){if(hi=!document.hidden,!hi){Gi(cn?"context-lost":"suspended",i);return}if(yh(),ne.mode==="live"&&Cr(performance.now(),!0),cn){Gi("context-lost",i);return}Gi("active",i),jo(),xh()}function bg(i){i.preventDefault(),cn=!0,vh(),Gi("context-lost","webglcontextlost"),document.body.dataset.bettaContext="lost"}function Eg(){cn=!1,document.body.dataset.bettaContext="restored",En?.resetState?.(),mh(),ki("webglcontextrestored")}function Tg(i,e){return new Promise((t,n)=>{try{let r=new Tr({antialias:!1,alpha:!1,powerPreference:"high-performance",preserveDrawingBuffer:!0,precision:"highp"});r.outputColorSpace=Mt,r.toneMapping=gr,r.toneMappingExposure=1.05,r.setPixelRatio(1),r.setSize(Math.max(1,Math.round(i)),Math.max(1,Math.round(e)),!1);let s=li.clone();s.aspect=Math.max(1,i)/Math.max(1,e),s.position.z=s.aspect<.7?10.4:9,s.updateProjectionMatrix(),r.render(qi,s);let a=r.domElement.toDataURL("image/png",1);r.dispose(),t(a)}catch(r){n(r)}})}function wg(){let i=Go(new Date);return{mode:ne.mode,timeZone:Vo,bangkokTime:i.label,periodKey:ne.period?.key||ne.targetPeriod?.key||null,periodName:ne.period?.name||ne.targetPeriod?.name||null,targetPeriodKey:ne.targetPeriod?.key||null,baseline:ne.period?.baseline||Kt,targetBaseline:ne.targetPeriod?.baseline||Kt,transitionMix:ne.mix,transitionRaw:ne.rawMix,transitionDurationMs:ne.duration,reason:ne.reason,rolloverMs:6e4,correctionMs:900,checkMs:3e4,previewDurationMs:ne.preview?.durationMs||null,periods:zi.map(e=>({...e}))}}async function xv(){if(ih)return;if(ih=!0,Vi=document.getElementById("environmentStage"),wr=document.getElementById("environmentCanvas"),!Vi||!wr||!window.WebGLRenderingContext){document.body.dataset.environmentWeather="unavailable";return}let i=Wo(new Date);Kt=i.baseline,ci=Qo(Kt),ne.period=i,ne.targetPeriod=i,ne.from=ci,ne.to=ci,qi=new hr,li=new St(32,1,.1,50),li.position.set(0,0,9),En=new Tr({canvas:wr,antialias:!1,alpha:!1,powerPreference:"high-performance",precision:"highp",preserveDrawingBuffer:!1}),En.outputColorSpace=Mt,En.toneMapping=gr,En.toneMappingExposure=1.05,En.setPixelRatio(nh),Vi.hidden=!1,jo(),mh(),Sa(),document.body.dataset.bettaFirstFrame="pending",document.body.dataset.environmentRenderer="sindhorn-betta-satellite-v1",document.body.dataset.environmentInput="satellite-only",document.body.dataset.bettaBaselineAuthority="bangkok-day-cycle",document.body.dataset.bettaContext="active",Gi(hi?"active":"suspended","initial"),new ResizeObserver(()=>jo()).observe(Vi),document.addEventListener("visibilitychange",()=>{document.hidden?qo("visibilitychange"):ki("visibilitychange")}),addEventListener("pagehide",()=>qo("pagehide")),addEventListener("pageshow",()=>ki("pageshow")),addEventListener("focus",()=>ki("focus")),document.addEventListener("freeze",()=>qo("freeze")),document.addEventListener("resume",()=>ki("resume")),wr.addEventListener("webglcontextlost",bg,!1),wr.addEventListener("webglcontextrestored",Eg,!1),document.addEventListener("sindhorn:route-mounted",$o),document.addEventListener("sindhorn:location-updated",()=>ya().catch(()=>{})),yh(),window.SindhornEnvironment={refreshWeather:()=>ya().catch(()=>ut),renderExport:Tg,setBettaBaseline:xg,setBettaPeriod:gh,useLiveBettaDayCycle:gg,previewBettaDayCycle:_g,getState:()=>({weather:{...ut,visual:sg(ut)},air:{...window.SindhornLiveData?.getState?.().air||{}},solar:null,lunar:null,location:{...window.SindhornLocation?.getState?.()||{}},quality:nh,config:null,seasonal:null,renderer:"sindhorn-betta-satellite-v1",inputMode:"satellite-only",betta:{baseline:ne.targetPeriod?.baseline||Kt,baselineAuthority:"bangkok-day-cycle",availableBaselines:[...hh],dayCycle:wg(),satelliteSource:jc,satelliteStatus:$e.status,observedAt:$e.state?.observedAt||null,metrics:$e.state?.metrics?{...$e.state.metrics}:null,lifecycle:uh,lifecycleReason:dh,contextLost:cn,satelliteStreaming:!!Hi,rendering:!!Tn,firstFrameRendered:Zo}}),applyConfig:()=>{}},xh(),ya().catch(()=>{}),setInterval(()=>ya().catch(()=>{}),600*1e3),setInterval(()=>{ne.mode==="live"&&!document.hidden&&Cr(performance.now())},3e4),setInterval(()=>{!document.hidden&&!cn&&!Tn&&ki("watchdog")},2e3)}export{xv as initEnvironment};
