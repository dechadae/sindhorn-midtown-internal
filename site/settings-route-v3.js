...
import {mountSettingsBusinessCard,preloadSettingsBusinessCard} from './business-card-settings.js?v=8';
...
export async function mountSettingsRoute(root){
  ...
  try{
    await Promise.all([
      ...
      ensureStyle('link[data-business-card-settings-style]','/business-card-settings.css?v=9','data-business-card-settings-style')
    ]);
