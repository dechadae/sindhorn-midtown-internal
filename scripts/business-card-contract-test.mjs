...
if(!routeRegistry.includes('settings-route-v3.js?v=8'))throw new Error('Settings presentation cache version missing');

for(const required of ['.business-card-present-close{position:absolute','top:48px','right:40px','width:36px','height:36px','background:rgba(250,247,245,.035)!important','font:100 22px/1 var(--font-ui)','top:44px;right:28px'])if(!settingsCss.includes(required))throw new Error(`Present close/Edit Card parity missing ${required}`);
